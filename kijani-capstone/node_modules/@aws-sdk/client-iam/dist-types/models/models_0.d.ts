import type { AccessAdvisorUsageGranularityType, AssertionEncryptionModeType, AssignmentStatusType, AttachmentType, ContextKeyTypeEnum, DeletionTaskStatusType, EncodingType, EntityType, FeatureType, GlobalEndpointTokenVersion, JobStatusType, ManagedByTypeType, ParameterTypeType, PermissionCheckResultType, PermissionCheckStatusType, PermissionsBoundaryAttachmentType, PolicyEvaluationDecisionType, PolicyIdentifierPolicyType, PolicyOwnerEntityType, PolicyParameterTypeEnum, PolicyScopeType, PolicySourceType, PolicyType, PolicyUsageType, ReportFormatType, ReportStateType, SortKeyType, StateType, StatusType, SummaryKeyType, SummaryStateType } from "./enums";
/**
 * @public
 */
 ...
 * @public
 */
export type PolicyIdentifier = PolicyIdentifier.InlinePolicyIdentifierMember | PolicyIdentifier.PolicyArnMember | PolicyIdentifier.PolicyTypeMember | PolicyIdentifier.$UnknownMember;
/**
 * @public
 */
export declare namespace PolicyIdentifier {
    /**
     ...
     * @public
     */
    interface InlinePolicyIdentifierMember {
        PolicyType?: never;
        PolicyArn?: never;
