...
export declare const ManagedByTypeType: {
  readonly Service: "Service";
};
export type ManagedByTypeType = (typeof ManagedByTypeType)[keyof typeof ManagedByTypeType];
export declare const ParameterTypeType: {
  readonly Arn: "Arn";
  readonly ArnList: "ArnList";
...
export declare const PolicyIdentifierPolicyType: {
  readonly AWS_MANAGED: "aws-managed";
  readonly INLINE: "inline";
  readonly PERMISSION_BOUNDARY: "permission-boundary";
  readonly RCP: "rcp";
  readonly SCP: "scp";
  readonly USER_MANAGED: "user-managed";
};
export type PolicyIdentifierPolicyType =
  (typeof PolicyIdentifierPolicyType)[keyof typeof PolicyIdentifierPolicyType];
