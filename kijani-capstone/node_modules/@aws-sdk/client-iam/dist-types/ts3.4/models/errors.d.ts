...
export declare class NameConflictException extends __BaseException {
  readonly name: "NameConflictException";
  readonly $fault: "client";
  constructor(opts: __ExceptionOptionType<NameConflictException, __BaseException>);
}
export declare class RoleModifiedException extends __BaseException {
  readonly name: "RoleModifiedException";
  readonly $fault: "client";
  constructor(opts: __ExceptionOptionType<RoleModifiedException, __BaseException>);
}
export declare class RoleTemplateDisabledException extends __BaseException {
  readonly name: "RoleTemplateDisabledException";
  readonly $fault: "client";
