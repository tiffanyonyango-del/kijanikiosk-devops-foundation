...
declare const UpdateRoleDescriptionCommand_base: {
    new (input: UpdateRoleDescriptionCommandInput): import("@smithy/core/client").CommandImpl<UpdateRoleDescriptionCommandInput, UpdateRoleDescriptionCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateRoleDescriptionCommandInput): import("@smithy/core/client").CommandImpl<UpdateRoleDescriptionCommandInput, UpdateRoleDescriptionCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
