...
declare const UntagSAMLProviderCommand_base: {
    new (input: UntagSAMLProviderCommandInput): import("@smithy/core/client").CommandImpl<UntagSAMLProviderCommandInput, UntagSAMLProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UntagSAMLProviderCommandInput): import("@smithy/core/client").CommandImpl<UntagSAMLProviderCommandInput, UntagSAMLProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
