...
declare const ListPolicyTagsCommand_base: {
    new (input: ListPolicyTagsCommandInput): import("@smithy/core/client").CommandImpl<ListPolicyTagsCommandInput, ListPolicyTagsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListPolicyTagsCommandInput): import("@smithy/core/client").CommandImpl<ListPolicyTagsCommandInput, ListPolicyTagsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
