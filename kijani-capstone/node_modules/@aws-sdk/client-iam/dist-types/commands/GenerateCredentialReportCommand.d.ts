...
declare const GenerateCredentialReportCommand_base: {
    new (input: GenerateCredentialReportCommandInput): import("@smithy/core/client").CommandImpl<GenerateCredentialReportCommandInput, GenerateCredentialReportCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GenerateCredentialReportCommandInput]): import("@smithy/core/client").CommandImpl<GenerateCredentialReportCommandInput, GenerateCredentialReportCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
