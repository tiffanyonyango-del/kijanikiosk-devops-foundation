...
declare const DeleteAccessKeyCommand_base: {
    new (input: DeleteAccessKeyCommandInput): import("@smithy/core/client").CommandImpl<DeleteAccessKeyCommandInput, DeleteAccessKeyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteAccessKeyCommandInput): import("@smithy/core/client").CommandImpl<DeleteAccessKeyCommandInput, DeleteAccessKeyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
