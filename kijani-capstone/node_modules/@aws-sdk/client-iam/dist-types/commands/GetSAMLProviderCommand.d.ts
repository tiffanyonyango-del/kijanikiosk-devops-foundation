...
declare const GetSAMLProviderCommand_base: {
    new (input: GetSAMLProviderCommandInput): import("@smithy/core/client").CommandImpl<GetSAMLProviderCommandInput, GetSAMLProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetSAMLProviderCommandInput): import("@smithy/core/client").CommandImpl<GetSAMLProviderCommandInput, GetSAMLProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
