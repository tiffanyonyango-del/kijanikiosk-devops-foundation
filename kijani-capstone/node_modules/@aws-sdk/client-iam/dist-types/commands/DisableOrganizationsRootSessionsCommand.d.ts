...
declare const DisableOrganizationsRootSessionsCommand_base: {
    new (input: DisableOrganizationsRootSessionsCommandInput): import("@smithy/core/client").CommandImpl<DisableOrganizationsRootSessionsCommandInput, DisableOrganizationsRootSessionsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DisableOrganizationsRootSessionsCommandInput]): import("@smithy/core/client").CommandImpl<DisableOrganizationsRootSessionsCommandInput, DisableOrganizationsRootSessionsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
