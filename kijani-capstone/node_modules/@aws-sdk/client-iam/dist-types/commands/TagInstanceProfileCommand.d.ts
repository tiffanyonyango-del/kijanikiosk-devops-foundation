...
declare const TagInstanceProfileCommand_base: {
    new (input: TagInstanceProfileCommandInput): import("@smithy/core/client").CommandImpl<TagInstanceProfileCommandInput, TagInstanceProfileCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TagInstanceProfileCommandInput): import("@smithy/core/client").CommandImpl<TagInstanceProfileCommandInput, TagInstanceProfileCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
