...
declare const PutUserPolicyCommand_base: {
    new (input: PutUserPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutUserPolicyCommandInput, PutUserPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutUserPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutUserPolicyCommandInput, PutUserPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
