...
declare const UpdateServerCertificateCommand_base: {
    new (input: UpdateServerCertificateCommandInput): import("@smithy/core/client").CommandImpl<UpdateServerCertificateCommandInput, UpdateServerCertificateCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateServerCertificateCommandInput): import("@smithy/core/client").CommandImpl<UpdateServerCertificateCommandInput, UpdateServerCertificateCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
