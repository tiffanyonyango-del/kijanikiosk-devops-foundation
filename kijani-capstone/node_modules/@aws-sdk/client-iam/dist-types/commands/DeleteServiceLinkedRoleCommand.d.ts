...
declare const DeleteServiceLinkedRoleCommand_base: {
    new (input: DeleteServiceLinkedRoleCommandInput): import("@smithy/core/client").CommandImpl<DeleteServiceLinkedRoleCommandInput, DeleteServiceLinkedRoleCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteServiceLinkedRoleCommandInput): import("@smithy/core/client").CommandImpl<DeleteServiceLinkedRoleCommandInput, DeleteServiceLinkedRoleCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
