...
declare const TagSAMLProviderCommand_base: {
    new (input: TagSAMLProviderCommandInput): import("@smithy/core/client").CommandImpl<TagSAMLProviderCommandInput, TagSAMLProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TagSAMLProviderCommandInput): import("@smithy/core/client").CommandImpl<TagSAMLProviderCommandInput, TagSAMLProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
