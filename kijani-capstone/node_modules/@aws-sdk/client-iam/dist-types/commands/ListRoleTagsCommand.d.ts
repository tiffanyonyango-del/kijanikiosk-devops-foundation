...
declare const ListRoleTagsCommand_base: {
    new (input: ListRoleTagsCommandInput): import("@smithy/core/client").CommandImpl<ListRoleTagsCommandInput, ListRoleTagsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListRoleTagsCommandInput): import("@smithy/core/client").CommandImpl<ListRoleTagsCommandInput, ListRoleTagsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
