...
declare const GetInstanceProfileCommand_base: {
    new (input: GetInstanceProfileCommandInput): import("@smithy/core/client").CommandImpl<GetInstanceProfileCommandInput, GetInstanceProfileCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetInstanceProfileCommandInput): import("@smithy/core/client").CommandImpl<GetInstanceProfileCommandInput, GetInstanceProfileCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
