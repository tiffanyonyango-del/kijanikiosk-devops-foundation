...
declare const UntagServerCertificateCommand_base: {
    new (input: UntagServerCertificateCommandInput): import("@smithy/core/client").CommandImpl<UntagServerCertificateCommandInput, UntagServerCertificateCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UntagServerCertificateCommandInput): import("@smithy/core/client").CommandImpl<UntagServerCertificateCommandInput, UntagServerCertificateCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
