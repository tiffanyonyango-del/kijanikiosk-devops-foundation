...
declare const DeleteServiceSpecificCredentialCommand_base: {
    new (input: DeleteServiceSpecificCredentialCommandInput): import("@smithy/core/client").CommandImpl<DeleteServiceSpecificCredentialCommandInput, DeleteServiceSpecificCredentialCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteServiceSpecificCredentialCommandInput): import("@smithy/core/client").CommandImpl<DeleteServiceSpecificCredentialCommandInput, DeleteServiceSpecificCredentialCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
