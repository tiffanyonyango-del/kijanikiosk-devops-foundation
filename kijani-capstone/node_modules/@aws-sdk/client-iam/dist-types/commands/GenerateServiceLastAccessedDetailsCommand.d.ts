...
declare const GenerateServiceLastAccessedDetailsCommand_base: {
    new (input: GenerateServiceLastAccessedDetailsCommandInput): import("@smithy/core/client").CommandImpl<GenerateServiceLastAccessedDetailsCommandInput, GenerateServiceLastAccessedDetailsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GenerateServiceLastAccessedDetailsCommandInput): import("@smithy/core/client").CommandImpl<GenerateServiceLastAccessedDetailsCommandInput, GenerateServiceLastAccessedDetailsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
