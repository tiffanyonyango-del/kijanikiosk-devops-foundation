...
declare const PutUserPermissionsBoundaryCommand_base: {
    new (input: PutUserPermissionsBoundaryCommandInput): import("@smithy/core/client").CommandImpl<PutUserPermissionsBoundaryCommandInput, PutUserPermissionsBoundaryCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutUserPermissionsBoundaryCommandInput): import("@smithy/core/client").CommandImpl<PutUserPermissionsBoundaryCommandInput, PutUserPermissionsBoundaryCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
