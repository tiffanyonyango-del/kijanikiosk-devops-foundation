...
declare const SimulateCustomPolicyCommand_base: {
    new (input: SimulateCustomPolicyCommandInput): import("@smithy/core/client").CommandImpl<SimulateCustomPolicyCommandInput, SimulateCustomPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SimulateCustomPolicyCommandInput): import("@smithy/core/client").CommandImpl<SimulateCustomPolicyCommandInput, SimulateCustomPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
