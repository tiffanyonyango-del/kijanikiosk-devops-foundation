...
declare const RejectDelegationRequestCommand_base: {
    new (input: RejectDelegationRequestCommandInput): import("@smithy/core/client").CommandImpl<RejectDelegationRequestCommandInput, RejectDelegationRequestCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RejectDelegationRequestCommandInput): import("@smithy/core/client").CommandImpl<RejectDelegationRequestCommandInput, RejectDelegationRequestCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
