...
declare const ListInstanceProfilesForRoleCommand_base: {
    new (input: ListInstanceProfilesForRoleCommandInput): import("@smithy/core/client").CommandImpl<ListInstanceProfilesForRoleCommandInput, ListInstanceProfilesForRoleCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListInstanceProfilesForRoleCommandInput): import("@smithy/core/client").CommandImpl<ListInstanceProfilesForRoleCommandInput, ListInstanceProfilesForRoleCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
