...
declare const UpdateServiceSpecificCredentialCommand_base: {
    new (input: UpdateServiceSpecificCredentialCommandInput): import("@smithy/core/client").CommandImpl<UpdateServiceSpecificCredentialCommandInput, UpdateServiceSpecificCredentialCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateServiceSpecificCredentialCommandInput): import("@smithy/core/client").CommandImpl<UpdateServiceSpecificCredentialCommandInput, UpdateServiceSpecificCredentialCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
