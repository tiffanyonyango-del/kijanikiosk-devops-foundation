...
declare const CreateOpenIDConnectProviderCommand_base: {
    new (input: CreateOpenIDConnectProviderCommandInput): import("@smithy/core/client").CommandImpl<CreateOpenIDConnectProviderCommandInput, CreateOpenIDConnectProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateOpenIDConnectProviderCommandInput): import("@smithy/core/client").CommandImpl<CreateOpenIDConnectProviderCommandInput, CreateOpenIDConnectProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
