...
declare const ListOpenIDConnectProviderTagsCommand_base: {
    new (input: ListOpenIDConnectProviderTagsCommandInput): import("@smithy/core/client").CommandImpl<ListOpenIDConnectProviderTagsCommandInput, ListOpenIDConnectProviderTagsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListOpenIDConnectProviderTagsCommandInput): import("@smithy/core/client").CommandImpl<ListOpenIDConnectProviderTagsCommandInput, ListOpenIDConnectProviderTagsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
