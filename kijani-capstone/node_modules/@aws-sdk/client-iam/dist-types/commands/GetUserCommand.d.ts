...
declare const GetUserCommand_base: {
    new (input: GetUserCommandInput): import("@smithy/core/client").CommandImpl<GetUserCommandInput, GetUserCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetUserCommandInput]): import("@smithy/core/client").CommandImpl<GetUserCommandInput, GetUserCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
