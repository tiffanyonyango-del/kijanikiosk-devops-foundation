...
declare const AcceptDelegationRequestCommand_base: {
    new (input: AcceptDelegationRequestCommandInput): import("@smithy/core/client").CommandImpl<AcceptDelegationRequestCommandInput, AcceptDelegationRequestCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AcceptDelegationRequestCommandInput): import("@smithy/core/client").CommandImpl<AcceptDelegationRequestCommandInput, AcceptDelegationRequestCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
