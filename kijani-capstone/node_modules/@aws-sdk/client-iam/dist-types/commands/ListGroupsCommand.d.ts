...
declare const ListGroupsCommand_base: {
    new (input: ListGroupsCommandInput): import("@smithy/core/client").CommandImpl<ListGroupsCommandInput, ListGroupsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListGroupsCommandInput]): import("@smithy/core/client").CommandImpl<ListGroupsCommandInput, ListGroupsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
