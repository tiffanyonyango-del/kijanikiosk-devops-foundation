...
declare const DisableOutboundWebIdentityFederationCommand_base: {
    new (input: DisableOutboundWebIdentityFederationCommandInput): import("@smithy/core/client").CommandImpl<DisableOutboundWebIdentityFederationCommandInput, DisableOutboundWebIdentityFederationCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DisableOutboundWebIdentityFederationCommandInput]): import("@smithy/core/client").CommandImpl<DisableOutboundWebIdentityFederationCommandInput, DisableOutboundWebIdentityFederationCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
