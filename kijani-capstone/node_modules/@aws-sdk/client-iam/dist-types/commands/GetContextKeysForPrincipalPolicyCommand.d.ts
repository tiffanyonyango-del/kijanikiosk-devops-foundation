...
declare const GetContextKeysForPrincipalPolicyCommand_base: {
    new (input: GetContextKeysForPrincipalPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetContextKeysForPrincipalPolicyCommandInput, GetContextKeysForPrincipalPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetContextKeysForPrincipalPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetContextKeysForPrincipalPolicyCommandInput, GetContextKeysForPrincipalPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
