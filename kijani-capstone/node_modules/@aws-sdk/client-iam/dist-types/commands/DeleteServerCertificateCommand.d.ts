...
declare const DeleteServerCertificateCommand_base: {
    new (input: DeleteServerCertificateCommandInput): import("@smithy/core/client").CommandImpl<DeleteServerCertificateCommandInput, DeleteServerCertificateCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteServerCertificateCommandInput): import("@smithy/core/client").CommandImpl<DeleteServerCertificateCommandInput, DeleteServerCertificateCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
