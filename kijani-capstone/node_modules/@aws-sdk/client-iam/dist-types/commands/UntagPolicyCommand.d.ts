...
declare const UntagPolicyCommand_base: {
    new (input: UntagPolicyCommandInput): import("@smithy/core/client").CommandImpl<UntagPolicyCommandInput, UntagPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UntagPolicyCommandInput): import("@smithy/core/client").CommandImpl<UntagPolicyCommandInput, UntagPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
