...
declare const CreatePolicyVersionCommand_base: {
    new (input: CreatePolicyVersionCommandInput): import("@smithy/core/client").CommandImpl<CreatePolicyVersionCommandInput, CreatePolicyVersionCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePolicyVersionCommandInput): import("@smithy/core/client").CommandImpl<CreatePolicyVersionCommandInput, CreatePolicyVersionCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
