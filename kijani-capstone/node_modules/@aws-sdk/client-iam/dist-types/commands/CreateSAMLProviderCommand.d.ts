...
declare const CreateSAMLProviderCommand_base: {
    new (input: CreateSAMLProviderCommandInput): import("@smithy/core/client").CommandImpl<CreateSAMLProviderCommandInput, CreateSAMLProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateSAMLProviderCommandInput): import("@smithy/core/client").CommandImpl<CreateSAMLProviderCommandInput, CreateSAMLProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
