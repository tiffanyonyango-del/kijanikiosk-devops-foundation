...
declare const PutRolePolicyCommand_base: {
    new (input: PutRolePolicyCommandInput): import("@smithy/core/client").CommandImpl<PutRolePolicyCommandInput, PutRolePolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutRolePolicyCommandInput): import("@smithy/core/client").CommandImpl<PutRolePolicyCommandInput, PutRolePolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
