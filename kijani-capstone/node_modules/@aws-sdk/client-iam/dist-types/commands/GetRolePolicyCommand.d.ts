...
declare const GetRolePolicyCommand_base: {
    new (input: GetRolePolicyCommandInput): import("@smithy/core/client").CommandImpl<GetRolePolicyCommandInput, GetRolePolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetRolePolicyCommandInput): import("@smithy/core/client").CommandImpl<GetRolePolicyCommandInput, GetRolePolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
