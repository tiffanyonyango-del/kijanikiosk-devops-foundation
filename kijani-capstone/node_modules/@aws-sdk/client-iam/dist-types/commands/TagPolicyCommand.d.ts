...
declare const TagPolicyCommand_base: {
    new (input: TagPolicyCommandInput): import("@smithy/core/client").CommandImpl<TagPolicyCommandInput, TagPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TagPolicyCommandInput): import("@smithy/core/client").CommandImpl<TagPolicyCommandInput, TagPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
