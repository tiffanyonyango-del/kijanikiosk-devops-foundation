...
declare const ListRolePoliciesCommand_base: {
    new (input: ListRolePoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListRolePoliciesCommandInput, ListRolePoliciesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListRolePoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListRolePoliciesCommandInput, ListRolePoliciesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
