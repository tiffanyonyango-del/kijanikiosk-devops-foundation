...
declare const ListRolesCommand_base: {
    new (input: ListRolesCommandInput): import("@smithy/core/client").CommandImpl<ListRolesCommandInput, ListRolesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListRolesCommandInput]): import("@smithy/core/client").CommandImpl<ListRolesCommandInput, ListRolesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
