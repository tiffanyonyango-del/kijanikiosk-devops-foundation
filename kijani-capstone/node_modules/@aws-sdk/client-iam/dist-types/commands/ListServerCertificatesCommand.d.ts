...
declare const ListServerCertificatesCommand_base: {
    new (input: ListServerCertificatesCommandInput): import("@smithy/core/client").CommandImpl<ListServerCertificatesCommandInput, ListServerCertificatesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListServerCertificatesCommandInput]): import("@smithy/core/client").CommandImpl<ListServerCertificatesCommandInput, ListServerCertificatesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
