...
declare const ListAttachedUserPoliciesCommand_base: {
    new (input: ListAttachedUserPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListAttachedUserPoliciesCommandInput, ListAttachedUserPoliciesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListAttachedUserPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListAttachedUserPoliciesCommandInput, ListAttachedUserPoliciesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
