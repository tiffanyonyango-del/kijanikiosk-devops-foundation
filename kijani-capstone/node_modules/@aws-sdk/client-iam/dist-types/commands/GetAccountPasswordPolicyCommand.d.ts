...
declare const GetAccountPasswordPolicyCommand_base: {
    new (input: GetAccountPasswordPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetAccountPasswordPolicyCommandInput, GetAccountPasswordPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetAccountPasswordPolicyCommandInput]): import("@smithy/core/client").CommandImpl<GetAccountPasswordPolicyCommandInput, GetAccountPasswordPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
