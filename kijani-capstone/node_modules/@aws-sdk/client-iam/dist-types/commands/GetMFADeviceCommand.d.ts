...
declare const GetMFADeviceCommand_base: {
    new (input: GetMFADeviceCommandInput): import("@smithy/core/client").CommandImpl<GetMFADeviceCommandInput, GetMFADeviceCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetMFADeviceCommandInput): import("@smithy/core/client").CommandImpl<GetMFADeviceCommandInput, GetMFADeviceCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
