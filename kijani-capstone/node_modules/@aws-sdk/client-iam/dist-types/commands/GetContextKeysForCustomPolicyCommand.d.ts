...
declare const GetContextKeysForCustomPolicyCommand_base: {
    new (input: GetContextKeysForCustomPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetContextKeysForCustomPolicyCommandInput, GetContextKeysForCustomPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetContextKeysForCustomPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetContextKeysForCustomPolicyCommandInput, GetContextKeysForCustomPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
