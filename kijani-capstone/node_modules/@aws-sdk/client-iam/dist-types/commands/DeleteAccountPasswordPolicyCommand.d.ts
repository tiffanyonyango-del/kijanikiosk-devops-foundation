...
declare const DeleteAccountPasswordPolicyCommand_base: {
    new (input: DeleteAccountPasswordPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteAccountPasswordPolicyCommandInput, DeleteAccountPasswordPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DeleteAccountPasswordPolicyCommandInput]): import("@smithy/core/client").CommandImpl<DeleteAccountPasswordPolicyCommandInput, DeleteAccountPasswordPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
