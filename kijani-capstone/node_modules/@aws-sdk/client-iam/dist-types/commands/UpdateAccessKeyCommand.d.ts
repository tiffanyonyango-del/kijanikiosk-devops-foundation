...
declare const UpdateAccessKeyCommand_base: {
    new (input: UpdateAccessKeyCommandInput): import("@smithy/core/client").CommandImpl<UpdateAccessKeyCommandInput, UpdateAccessKeyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateAccessKeyCommandInput): import("@smithy/core/client").CommandImpl<UpdateAccessKeyCommandInput, UpdateAccessKeyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
