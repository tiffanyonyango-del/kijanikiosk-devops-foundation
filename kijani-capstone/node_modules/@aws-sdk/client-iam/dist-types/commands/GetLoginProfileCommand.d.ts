...
declare const GetLoginProfileCommand_base: {
    new (input: GetLoginProfileCommandInput): import("@smithy/core/client").CommandImpl<GetLoginProfileCommandInput, GetLoginProfileCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetLoginProfileCommandInput]): import("@smithy/core/client").CommandImpl<GetLoginProfileCommandInput, GetLoginProfileCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
