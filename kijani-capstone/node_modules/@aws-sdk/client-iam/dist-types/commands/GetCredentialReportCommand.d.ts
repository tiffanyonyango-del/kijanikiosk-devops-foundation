...
declare const GetCredentialReportCommand_base: {
    new (input: GetCredentialReportCommandInput): import("@smithy/core/client").CommandImpl<GetCredentialReportCommandInput, GetCredentialReportCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetCredentialReportCommandInput]): import("@smithy/core/client").CommandImpl<GetCredentialReportCommandInput, GetCredentialReportCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
