...
declare const CreateInstanceProfileCommand_base: {
    new (input: CreateInstanceProfileCommandInput): import("@smithy/core/client").CommandImpl<CreateInstanceProfileCommandInput, CreateInstanceProfileCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateInstanceProfileCommandInput): import("@smithy/core/client").CommandImpl<CreateInstanceProfileCommandInput, CreateInstanceProfileCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
