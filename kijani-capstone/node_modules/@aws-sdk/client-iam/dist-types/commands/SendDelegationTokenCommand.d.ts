...
declare const SendDelegationTokenCommand_base: {
    new (input: SendDelegationTokenCommandInput): import("@smithy/core/client").CommandImpl<SendDelegationTokenCommandInput, SendDelegationTokenCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SendDelegationTokenCommandInput): import("@smithy/core/client").CommandImpl<SendDelegationTokenCommandInput, SendDelegationTokenCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
