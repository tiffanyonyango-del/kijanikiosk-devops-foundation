...
declare const UpdateOpenIDConnectProviderThumbprintCommand_base: {
    new (input: UpdateOpenIDConnectProviderThumbprintCommandInput): import("@smithy/core/client").CommandImpl<UpdateOpenIDConnectProviderThumbprintCommandInput, UpdateOpenIDConnectProviderThumbprintCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateOpenIDConnectProviderThumbprintCommandInput): import("@smithy/core/client").CommandImpl<UpdateOpenIDConnectProviderThumbprintCommandInput, UpdateOpenIDConnectProviderThumbprintCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
