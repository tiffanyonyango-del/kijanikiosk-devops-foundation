...
declare const ResyncMFADeviceCommand_base: {
    new (input: ResyncMFADeviceCommandInput): import("@smithy/core/client").CommandImpl<ResyncMFADeviceCommandInput, ResyncMFADeviceCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ResyncMFADeviceCommandInput): import("@smithy/core/client").CommandImpl<ResyncMFADeviceCommandInput, ResyncMFADeviceCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
