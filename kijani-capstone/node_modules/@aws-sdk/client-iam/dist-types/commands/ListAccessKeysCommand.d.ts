...
declare const ListAccessKeysCommand_base: {
    new (input: ListAccessKeysCommandInput): import("@smithy/core/client").CommandImpl<ListAccessKeysCommandInput, ListAccessKeysCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAccessKeysCommandInput]): import("@smithy/core/client").CommandImpl<ListAccessKeysCommandInput, ListAccessKeysCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
