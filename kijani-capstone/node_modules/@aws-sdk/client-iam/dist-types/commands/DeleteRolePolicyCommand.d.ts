...
declare const DeleteRolePolicyCommand_base: {
    new (input: DeleteRolePolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteRolePolicyCommandInput, DeleteRolePolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteRolePolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteRolePolicyCommandInput, DeleteRolePolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
