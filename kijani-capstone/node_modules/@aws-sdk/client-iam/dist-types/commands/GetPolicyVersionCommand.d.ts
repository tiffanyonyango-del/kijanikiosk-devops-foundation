...
declare const GetPolicyVersionCommand_base: {
    new (input: GetPolicyVersionCommandInput): import("@smithy/core/client").CommandImpl<GetPolicyVersionCommandInput, GetPolicyVersionCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPolicyVersionCommandInput): import("@smithy/core/client").CommandImpl<GetPolicyVersionCommandInput, GetPolicyVersionCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
