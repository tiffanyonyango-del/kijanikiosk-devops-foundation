...
declare const DetachGroupPolicyCommand_base: {
    new (input: DetachGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<DetachGroupPolicyCommandInput, DetachGroupPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetachGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<DetachGroupPolicyCommandInput, DetachGroupPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
