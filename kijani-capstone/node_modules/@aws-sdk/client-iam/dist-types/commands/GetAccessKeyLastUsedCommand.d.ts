...
declare const GetAccessKeyLastUsedCommand_base: {
    new (input: GetAccessKeyLastUsedCommandInput): import("@smithy/core/client").CommandImpl<GetAccessKeyLastUsedCommandInput, GetAccessKeyLastUsedCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetAccessKeyLastUsedCommandInput): import("@smithy/core/client").CommandImpl<GetAccessKeyLastUsedCommandInput, GetAccessKeyLastUsedCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
