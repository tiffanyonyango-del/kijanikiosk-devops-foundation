...
declare const GetAccountSummaryCommand_base: {
    new (input: GetAccountSummaryCommandInput): import("@smithy/core/client").CommandImpl<GetAccountSummaryCommandInput, GetAccountSummaryCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetAccountSummaryCommandInput]): import("@smithy/core/client").CommandImpl<GetAccountSummaryCommandInput, GetAccountSummaryCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
