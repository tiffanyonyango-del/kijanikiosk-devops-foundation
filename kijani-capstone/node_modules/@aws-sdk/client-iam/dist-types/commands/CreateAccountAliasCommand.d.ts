...
declare const CreateAccountAliasCommand_base: {
    new (input: CreateAccountAliasCommandInput): import("@smithy/core/client").CommandImpl<CreateAccountAliasCommandInput, CreateAccountAliasCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateAccountAliasCommandInput): import("@smithy/core/client").CommandImpl<CreateAccountAliasCommandInput, CreateAccountAliasCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
