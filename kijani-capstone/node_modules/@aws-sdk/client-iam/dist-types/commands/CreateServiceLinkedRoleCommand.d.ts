...
declare const CreateServiceLinkedRoleCommand_base: {
    new (input: CreateServiceLinkedRoleCommandInput): import("@smithy/core/client").CommandImpl<CreateServiceLinkedRoleCommandInput, CreateServiceLinkedRoleCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateServiceLinkedRoleCommandInput): import("@smithy/core/client").CommandImpl<CreateServiceLinkedRoleCommandInput, CreateServiceLinkedRoleCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
