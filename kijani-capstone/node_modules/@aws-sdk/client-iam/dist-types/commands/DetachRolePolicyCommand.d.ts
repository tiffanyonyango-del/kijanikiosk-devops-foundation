...
declare const DetachRolePolicyCommand_base: {
    new (input: DetachRolePolicyCommandInput): import("@smithy/core/client").CommandImpl<DetachRolePolicyCommandInput, DetachRolePolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetachRolePolicyCommandInput): import("@smithy/core/client").CommandImpl<DetachRolePolicyCommandInput, DetachRolePolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
