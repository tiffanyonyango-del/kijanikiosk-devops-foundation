...
declare const UntagOpenIDConnectProviderCommand_base: {
    new (input: UntagOpenIDConnectProviderCommandInput): import("@smithy/core/client").CommandImpl<UntagOpenIDConnectProviderCommandInput, UntagOpenIDConnectProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UntagOpenIDConnectProviderCommandInput): import("@smithy/core/client").CommandImpl<UntagOpenIDConnectProviderCommandInput, UntagOpenIDConnectProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
