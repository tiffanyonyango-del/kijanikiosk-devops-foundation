...
declare const ListPolicyVersionsCommand_base: {
    new (input: ListPolicyVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListPolicyVersionsCommandInput, ListPolicyVersionsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListPolicyVersionsCommandInput): import("@smithy/core/client").CommandImpl<ListPolicyVersionsCommandInput, ListPolicyVersionsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
