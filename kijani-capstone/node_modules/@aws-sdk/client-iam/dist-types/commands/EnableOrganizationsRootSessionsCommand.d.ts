...
declare const EnableOrganizationsRootSessionsCommand_base: {
    new (input: EnableOrganizationsRootSessionsCommandInput): import("@smithy/core/client").CommandImpl<EnableOrganizationsRootSessionsCommandInput, EnableOrganizationsRootSessionsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [EnableOrganizationsRootSessionsCommandInput]): import("@smithy/core/client").CommandImpl<EnableOrganizationsRootSessionsCommandInput, EnableOrganizationsRootSessionsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
