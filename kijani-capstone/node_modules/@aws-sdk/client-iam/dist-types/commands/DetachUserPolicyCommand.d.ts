...
declare const DetachUserPolicyCommand_base: {
    new (input: DetachUserPolicyCommandInput): import("@smithy/core/client").CommandImpl<DetachUserPolicyCommandInput, DetachUserPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetachUserPolicyCommandInput): import("@smithy/core/client").CommandImpl<DetachUserPolicyCommandInput, DetachUserPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
