...
declare const DeleteAccountAliasCommand_base: {
    new (input: DeleteAccountAliasCommandInput): import("@smithy/core/client").CommandImpl<DeleteAccountAliasCommandInput, DeleteAccountAliasCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteAccountAliasCommandInput): import("@smithy/core/client").CommandImpl<DeleteAccountAliasCommandInput, DeleteAccountAliasCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
