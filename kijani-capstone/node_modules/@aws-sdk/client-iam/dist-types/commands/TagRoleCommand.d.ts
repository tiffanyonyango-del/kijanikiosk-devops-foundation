...
declare const TagRoleCommand_base: {
    new (input: TagRoleCommandInput): import("@smithy/core/client").CommandImpl<TagRoleCommandInput, TagRoleCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TagRoleCommandInput): import("@smithy/core/client").CommandImpl<TagRoleCommandInput, TagRoleCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
