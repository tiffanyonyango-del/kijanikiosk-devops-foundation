...
declare const ListInstanceProfilesCommand_base: {
    new (input: ListInstanceProfilesCommandInput): import("@smithy/core/client").CommandImpl<ListInstanceProfilesCommandInput, ListInstanceProfilesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListInstanceProfilesCommandInput]): import("@smithy/core/client").CommandImpl<ListInstanceProfilesCommandInput, ListInstanceProfilesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
