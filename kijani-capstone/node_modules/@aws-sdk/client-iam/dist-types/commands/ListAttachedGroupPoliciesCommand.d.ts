...
declare const ListAttachedGroupPoliciesCommand_base: {
    new (input: ListAttachedGroupPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListAttachedGroupPoliciesCommandInput, ListAttachedGroupPoliciesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListAttachedGroupPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListAttachedGroupPoliciesCommandInput, ListAttachedGroupPoliciesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
