...
declare const ListSigningCertificatesCommand_base: {
    new (input: ListSigningCertificatesCommandInput): import("@smithy/core/client").CommandImpl<ListSigningCertificatesCommandInput, ListSigningCertificatesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListSigningCertificatesCommandInput]): import("@smithy/core/client").CommandImpl<ListSigningCertificatesCommandInput, ListSigningCertificatesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
