...
declare const ListSAMLProvidersCommand_base: {
    new (input: ListSAMLProvidersCommandInput): import("@smithy/core/client").CommandImpl<ListSAMLProvidersCommandInput, ListSAMLProvidersCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListSAMLProvidersCommandInput]): import("@smithy/core/client").CommandImpl<ListSAMLProvidersCommandInput, ListSAMLProvidersCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
