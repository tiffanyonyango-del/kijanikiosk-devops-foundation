...
declare const DeleteGroupPolicyCommand_base: {
    new (input: DeleteGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteGroupPolicyCommandInput, DeleteGroupPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteGroupPolicyCommandInput, DeleteGroupPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
