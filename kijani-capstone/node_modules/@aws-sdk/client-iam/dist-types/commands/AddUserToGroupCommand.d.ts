...
declare const AddUserToGroupCommand_base: {
    new (input: AddUserToGroupCommandInput): import("@smithy/core/client").CommandImpl<AddUserToGroupCommandInput, AddUserToGroupCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AddUserToGroupCommandInput): import("@smithy/core/client").CommandImpl<AddUserToGroupCommandInput, AddUserToGroupCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
