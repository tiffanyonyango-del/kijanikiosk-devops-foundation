...
declare const UntagInstanceProfileCommand_base: {
    new (input: UntagInstanceProfileCommandInput): import("@smithy/core/client").CommandImpl<UntagInstanceProfileCommandInput, UntagInstanceProfileCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UntagInstanceProfileCommandInput): import("@smithy/core/client").CommandImpl<UntagInstanceProfileCommandInput, UntagInstanceProfileCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
