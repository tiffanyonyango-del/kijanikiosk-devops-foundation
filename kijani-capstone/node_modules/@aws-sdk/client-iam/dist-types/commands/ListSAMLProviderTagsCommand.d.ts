...
declare const ListSAMLProviderTagsCommand_base: {
    new (input: ListSAMLProviderTagsCommandInput): import("@smithy/core/client").CommandImpl<ListSAMLProviderTagsCommandInput, ListSAMLProviderTagsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListSAMLProviderTagsCommandInput): import("@smithy/core/client").CommandImpl<ListSAMLProviderTagsCommandInput, ListSAMLProviderTagsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
