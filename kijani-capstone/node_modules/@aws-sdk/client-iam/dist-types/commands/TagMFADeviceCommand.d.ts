...
declare const TagMFADeviceCommand_base: {
    new (input: TagMFADeviceCommandInput): import("@smithy/core/client").CommandImpl<TagMFADeviceCommandInput, TagMFADeviceCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TagMFADeviceCommandInput): import("@smithy/core/client").CommandImpl<TagMFADeviceCommandInput, TagMFADeviceCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
