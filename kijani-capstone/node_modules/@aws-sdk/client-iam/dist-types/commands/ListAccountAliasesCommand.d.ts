...
declare const ListAccountAliasesCommand_base: {
    new (input: ListAccountAliasesCommandInput): import("@smithy/core/client").CommandImpl<ListAccountAliasesCommandInput, ListAccountAliasesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListAccountAliasesCommandInput]): import("@smithy/core/client").CommandImpl<ListAccountAliasesCommandInput, ListAccountAliasesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
