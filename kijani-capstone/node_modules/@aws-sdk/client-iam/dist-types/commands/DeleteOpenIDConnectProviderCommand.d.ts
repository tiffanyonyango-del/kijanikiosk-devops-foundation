...
declare const DeleteOpenIDConnectProviderCommand_base: {
    new (input: DeleteOpenIDConnectProviderCommandInput): import("@smithy/core/client").CommandImpl<DeleteOpenIDConnectProviderCommandInput, DeleteOpenIDConnectProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteOpenIDConnectProviderCommandInput): import("@smithy/core/client").CommandImpl<DeleteOpenIDConnectProviderCommandInput, DeleteOpenIDConnectProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
