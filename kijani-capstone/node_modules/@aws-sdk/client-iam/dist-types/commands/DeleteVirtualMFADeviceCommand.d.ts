...
declare const DeleteVirtualMFADeviceCommand_base: {
    new (input: DeleteVirtualMFADeviceCommandInput): import("@smithy/core/client").CommandImpl<DeleteVirtualMFADeviceCommandInput, DeleteVirtualMFADeviceCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVirtualMFADeviceCommandInput): import("@smithy/core/client").CommandImpl<DeleteVirtualMFADeviceCommandInput, DeleteVirtualMFADeviceCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
