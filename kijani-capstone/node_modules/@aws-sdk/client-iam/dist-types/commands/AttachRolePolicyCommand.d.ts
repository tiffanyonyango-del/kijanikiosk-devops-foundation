...
declare const AttachRolePolicyCommand_base: {
    new (input: AttachRolePolicyCommandInput): import("@smithy/core/client").CommandImpl<AttachRolePolicyCommandInput, AttachRolePolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AttachRolePolicyCommandInput): import("@smithy/core/client").CommandImpl<AttachRolePolicyCommandInput, AttachRolePolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
