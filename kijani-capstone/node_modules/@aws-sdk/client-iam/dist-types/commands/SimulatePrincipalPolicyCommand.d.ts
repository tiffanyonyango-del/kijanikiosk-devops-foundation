...
declare const SimulatePrincipalPolicyCommand_base: {
    new (input: SimulatePrincipalPolicyCommandInput): import("@smithy/core/client").CommandImpl<SimulatePrincipalPolicyCommandInput, SimulatePrincipalPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SimulatePrincipalPolicyCommandInput): import("@smithy/core/client").CommandImpl<SimulatePrincipalPolicyCommandInput, SimulatePrincipalPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
