...
declare const GetServiceLastAccessedDetailsCommand_base: {
    new (input: GetServiceLastAccessedDetailsCommandInput): import("@smithy/core/client").CommandImpl<GetServiceLastAccessedDetailsCommandInput, GetServiceLastAccessedDetailsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetServiceLastAccessedDetailsCommandInput): import("@smithy/core/client").CommandImpl<GetServiceLastAccessedDetailsCommandInput, GetServiceLastAccessedDetailsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
