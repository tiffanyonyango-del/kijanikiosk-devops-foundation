...
declare const UpdateSigningCertificateCommand_base: {
    new (input: UpdateSigningCertificateCommandInput): import("@smithy/core/client").CommandImpl<UpdateSigningCertificateCommandInput, UpdateSigningCertificateCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateSigningCertificateCommandInput): import("@smithy/core/client").CommandImpl<UpdateSigningCertificateCommandInput, UpdateSigningCertificateCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
