...
declare const ListInstanceProfileTagsCommand_base: {
    new (input: ListInstanceProfileTagsCommandInput): import("@smithy/core/client").CommandImpl<ListInstanceProfileTagsCommandInput, ListInstanceProfileTagsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListInstanceProfileTagsCommandInput): import("@smithy/core/client").CommandImpl<ListInstanceProfileTagsCommandInput, ListInstanceProfileTagsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
