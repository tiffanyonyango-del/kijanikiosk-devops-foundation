...
declare const UploadServerCertificateCommand_base: {
    new (input: UploadServerCertificateCommandInput): import("@smithy/core/client").CommandImpl<UploadServerCertificateCommandInput, UploadServerCertificateCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UploadServerCertificateCommandInput): import("@smithy/core/client").CommandImpl<UploadServerCertificateCommandInput, UploadServerCertificateCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
