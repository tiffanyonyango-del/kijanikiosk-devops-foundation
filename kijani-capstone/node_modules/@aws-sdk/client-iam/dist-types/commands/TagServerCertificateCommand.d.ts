...
declare const TagServerCertificateCommand_base: {
    new (input: TagServerCertificateCommandInput): import("@smithy/core/client").CommandImpl<TagServerCertificateCommandInput, TagServerCertificateCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TagServerCertificateCommandInput): import("@smithy/core/client").CommandImpl<TagServerCertificateCommandInput, TagServerCertificateCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
