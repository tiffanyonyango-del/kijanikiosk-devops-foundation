...
declare const GetRoleCommand_base: {
    new (input: GetRoleCommandInput): import("@smithy/core/client").CommandImpl<GetRoleCommandInput, GetRoleCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetRoleCommandInput): import("@smithy/core/client").CommandImpl<GetRoleCommandInput, GetRoleCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
