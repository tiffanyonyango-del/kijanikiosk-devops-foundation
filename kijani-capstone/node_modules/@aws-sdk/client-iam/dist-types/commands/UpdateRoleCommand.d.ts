...
declare const UpdateRoleCommand_base: {
    new (input: UpdateRoleCommandInput): import("@smithy/core/client").CommandImpl<UpdateRoleCommandInput, UpdateRoleCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateRoleCommandInput): import("@smithy/core/client").CommandImpl<UpdateRoleCommandInput, UpdateRoleCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
