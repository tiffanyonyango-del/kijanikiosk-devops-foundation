...
declare const GetUserPolicyCommand_base: {
    new (input: GetUserPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetUserPolicyCommandInput, GetUserPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetUserPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetUserPolicyCommandInput, GetUserPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
