...
declare const EnableMFADeviceCommand_base: {
    new (input: EnableMFADeviceCommandInput): import("@smithy/core/client").CommandImpl<EnableMFADeviceCommandInput, EnableMFADeviceCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableMFADeviceCommandInput): import("@smithy/core/client").CommandImpl<EnableMFADeviceCommandInput, EnableMFADeviceCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
