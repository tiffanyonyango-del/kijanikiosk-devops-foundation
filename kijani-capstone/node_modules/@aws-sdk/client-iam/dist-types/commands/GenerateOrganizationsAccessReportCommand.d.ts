...
declare const GenerateOrganizationsAccessReportCommand_base: {
    new (input: GenerateOrganizationsAccessReportCommandInput): import("@smithy/core/client").CommandImpl<GenerateOrganizationsAccessReportCommandInput, GenerateOrganizationsAccessReportCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GenerateOrganizationsAccessReportCommandInput): import("@smithy/core/client").CommandImpl<GenerateOrganizationsAccessReportCommandInput, GenerateOrganizationsAccessReportCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
