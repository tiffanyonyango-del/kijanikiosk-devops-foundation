...
declare const ListMFADeviceTagsCommand_base: {
    new (input: ListMFADeviceTagsCommandInput): import("@smithy/core/client").CommandImpl<ListMFADeviceTagsCommandInput, ListMFADeviceTagsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListMFADeviceTagsCommandInput): import("@smithy/core/client").CommandImpl<ListMFADeviceTagsCommandInput, ListMFADeviceTagsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
