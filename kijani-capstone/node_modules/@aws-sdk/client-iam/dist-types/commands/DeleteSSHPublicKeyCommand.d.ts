...
declare const DeleteSSHPublicKeyCommand_base: {
    new (input: DeleteSSHPublicKeyCommandInput): import("@smithy/core/client").CommandImpl<DeleteSSHPublicKeyCommandInput, DeleteSSHPublicKeyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteSSHPublicKeyCommandInput): import("@smithy/core/client").CommandImpl<DeleteSSHPublicKeyCommandInput, DeleteSSHPublicKeyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
