...
declare const DeleteInstanceProfileCommand_base: {
    new (input: DeleteInstanceProfileCommandInput): import("@smithy/core/client").CommandImpl<DeleteInstanceProfileCommandInput, DeleteInstanceProfileCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteInstanceProfileCommandInput): import("@smithy/core/client").CommandImpl<DeleteInstanceProfileCommandInput, DeleteInstanceProfileCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
