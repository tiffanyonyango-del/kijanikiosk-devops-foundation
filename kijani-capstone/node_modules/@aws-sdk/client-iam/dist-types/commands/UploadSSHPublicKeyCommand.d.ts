...
declare const UploadSSHPublicKeyCommand_base: {
    new (input: UploadSSHPublicKeyCommandInput): import("@smithy/core/client").CommandImpl<UploadSSHPublicKeyCommandInput, UploadSSHPublicKeyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UploadSSHPublicKeyCommandInput): import("@smithy/core/client").CommandImpl<UploadSSHPublicKeyCommandInput, UploadSSHPublicKeyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
