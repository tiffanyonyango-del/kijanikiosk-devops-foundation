...
declare const GetSSHPublicKeyCommand_base: {
    new (input: GetSSHPublicKeyCommandInput): import("@smithy/core/client").CommandImpl<GetSSHPublicKeyCommandInput, GetSSHPublicKeyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetSSHPublicKeyCommandInput): import("@smithy/core/client").CommandImpl<GetSSHPublicKeyCommandInput, GetSSHPublicKeyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
