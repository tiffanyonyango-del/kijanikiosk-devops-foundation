...
declare const DeleteRoleCommand_base: {
    new (input: DeleteRoleCommandInput): import("@smithy/core/client").CommandImpl<DeleteRoleCommandInput, DeleteRoleCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteRoleCommandInput): import("@smithy/core/client").CommandImpl<DeleteRoleCommandInput, DeleteRoleCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
