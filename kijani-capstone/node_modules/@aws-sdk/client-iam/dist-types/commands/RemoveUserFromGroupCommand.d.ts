...
declare const RemoveUserFromGroupCommand_base: {
    new (input: RemoveUserFromGroupCommandInput): import("@smithy/core/client").CommandImpl<RemoveUserFromGroupCommandInput, RemoveUserFromGroupCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RemoveUserFromGroupCommandInput): import("@smithy/core/client").CommandImpl<RemoveUserFromGroupCommandInput, RemoveUserFromGroupCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
