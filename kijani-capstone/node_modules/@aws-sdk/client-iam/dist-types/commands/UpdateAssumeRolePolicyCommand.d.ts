...
declare const UpdateAssumeRolePolicyCommand_base: {
    new (input: UpdateAssumeRolePolicyCommandInput): import("@smithy/core/client").CommandImpl<UpdateAssumeRolePolicyCommandInput, UpdateAssumeRolePolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateAssumeRolePolicyCommandInput): import("@smithy/core/client").CommandImpl<UpdateAssumeRolePolicyCommandInput, UpdateAssumeRolePolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
