...
declare const DeleteUserPermissionsBoundaryCommand_base: {
    new (input: DeleteUserPermissionsBoundaryCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserPermissionsBoundaryCommandInput, DeleteUserPermissionsBoundaryCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteUserPermissionsBoundaryCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserPermissionsBoundaryCommandInput, DeleteUserPermissionsBoundaryCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
