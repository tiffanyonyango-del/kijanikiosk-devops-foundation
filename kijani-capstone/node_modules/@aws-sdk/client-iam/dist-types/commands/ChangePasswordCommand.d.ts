...
declare const ChangePasswordCommand_base: {
    new (input: ChangePasswordCommandInput): import("@smithy/core/client").CommandImpl<ChangePasswordCommandInput, ChangePasswordCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ChangePasswordCommandInput): import("@smithy/core/client").CommandImpl<ChangePasswordCommandInput, ChangePasswordCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
