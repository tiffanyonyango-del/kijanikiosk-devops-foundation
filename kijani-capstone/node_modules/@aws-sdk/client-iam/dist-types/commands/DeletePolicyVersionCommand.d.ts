...
declare const DeletePolicyVersionCommand_base: {
    new (input: DeletePolicyVersionCommandInput): import("@smithy/core/client").CommandImpl<DeletePolicyVersionCommandInput, DeletePolicyVersionCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeletePolicyVersionCommandInput): import("@smithy/core/client").CommandImpl<DeletePolicyVersionCommandInput, DeletePolicyVersionCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
