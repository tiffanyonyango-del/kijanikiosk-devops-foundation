...
declare const DeleteUserPolicyCommand_base: {
    new (input: DeleteUserPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserPolicyCommandInput, DeleteUserPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteUserPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteUserPolicyCommandInput, DeleteUserPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
