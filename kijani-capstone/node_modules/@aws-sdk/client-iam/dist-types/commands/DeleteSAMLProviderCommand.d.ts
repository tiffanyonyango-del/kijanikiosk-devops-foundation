...
declare const DeleteSAMLProviderCommand_base: {
    new (input: DeleteSAMLProviderCommandInput): import("@smithy/core/client").CommandImpl<DeleteSAMLProviderCommandInput, DeleteSAMLProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteSAMLProviderCommandInput): import("@smithy/core/client").CommandImpl<DeleteSAMLProviderCommandInput, DeleteSAMLProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
