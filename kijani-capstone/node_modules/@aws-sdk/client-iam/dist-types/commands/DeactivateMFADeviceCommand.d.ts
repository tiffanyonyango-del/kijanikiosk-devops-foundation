...
declare const DeactivateMFADeviceCommand_base: {
    new (input: DeactivateMFADeviceCommandInput): import("@smithy/core/client").CommandImpl<DeactivateMFADeviceCommandInput, DeactivateMFADeviceCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeactivateMFADeviceCommandInput): import("@smithy/core/client").CommandImpl<DeactivateMFADeviceCommandInput, DeactivateMFADeviceCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
