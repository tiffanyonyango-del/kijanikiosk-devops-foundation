...
declare const ListVirtualMFADevicesCommand_base: {
    new (input: ListVirtualMFADevicesCommandInput): import("@smithy/core/client").CommandImpl<ListVirtualMFADevicesCommandInput, ListVirtualMFADevicesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListVirtualMFADevicesCommandInput]): import("@smithy/core/client").CommandImpl<ListVirtualMFADevicesCommandInput, ListVirtualMFADevicesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
