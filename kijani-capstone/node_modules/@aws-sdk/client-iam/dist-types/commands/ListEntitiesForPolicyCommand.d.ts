...
declare const ListEntitiesForPolicyCommand_base: {
    new (input: ListEntitiesForPolicyCommandInput): import("@smithy/core/client").CommandImpl<ListEntitiesForPolicyCommandInput, ListEntitiesForPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListEntitiesForPolicyCommandInput): import("@smithy/core/client").CommandImpl<ListEntitiesForPolicyCommandInput, ListEntitiesForPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
