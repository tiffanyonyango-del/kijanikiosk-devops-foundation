...
declare const UntagUserCommand_base: {
    new (input: UntagUserCommandInput): import("@smithy/core/client").CommandImpl<UntagUserCommandInput, UntagUserCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UntagUserCommandInput): import("@smithy/core/client").CommandImpl<UntagUserCommandInput, UntagUserCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
