...
declare const UntagRoleCommand_base: {
    new (input: UntagRoleCommandInput): import("@smithy/core/client").CommandImpl<UntagRoleCommandInput, UntagRoleCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UntagRoleCommandInput): import("@smithy/core/client").CommandImpl<UntagRoleCommandInput, UntagRoleCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
