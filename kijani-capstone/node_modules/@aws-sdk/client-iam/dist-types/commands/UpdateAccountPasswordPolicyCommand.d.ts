...
declare const UpdateAccountPasswordPolicyCommand_base: {
    new (input: UpdateAccountPasswordPolicyCommandInput): import("@smithy/core/client").CommandImpl<UpdateAccountPasswordPolicyCommandInput, UpdateAccountPasswordPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [UpdateAccountPasswordPolicyCommandInput]): import("@smithy/core/client").CommandImpl<UpdateAccountPasswordPolicyCommandInput, UpdateAccountPasswordPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
