...
declare const CreateRoleCommand_base: {
    new (input: CreateRoleCommandInput): import("@smithy/core/client").CommandImpl<CreateRoleCommandInput, CreateRoleCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateRoleCommandInput): import("@smithy/core/client").CommandImpl<CreateRoleCommandInput, CreateRoleCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
