...
declare const UpdateSSHPublicKeyCommand_base: {
    new (input: UpdateSSHPublicKeyCommandInput): import("@smithy/core/client").CommandImpl<UpdateSSHPublicKeyCommandInput, UpdateSSHPublicKeyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateSSHPublicKeyCommandInput): import("@smithy/core/client").CommandImpl<UpdateSSHPublicKeyCommandInput, UpdateSSHPublicKeyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
