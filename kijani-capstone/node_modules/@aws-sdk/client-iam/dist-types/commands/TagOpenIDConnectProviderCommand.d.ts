...
declare const TagOpenIDConnectProviderCommand_base: {
    new (input: TagOpenIDConnectProviderCommandInput): import("@smithy/core/client").CommandImpl<TagOpenIDConnectProviderCommandInput, TagOpenIDConnectProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TagOpenIDConnectProviderCommandInput): import("@smithy/core/client").CommandImpl<TagOpenIDConnectProviderCommandInput, TagOpenIDConnectProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
