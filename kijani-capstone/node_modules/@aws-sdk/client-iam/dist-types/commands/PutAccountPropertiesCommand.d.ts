...
declare const PutAccountPropertiesCommand_base: {
    new (input: PutAccountPropertiesCommandInput): import("@smithy/core/client").CommandImpl<PutAccountPropertiesCommandInput, PutAccountPropertiesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutAccountPropertiesCommandInput): import("@smithy/core/client").CommandImpl<PutAccountPropertiesCommandInput, PutAccountPropertiesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class PutAccountPropertiesCommand extends PutAccountPropertiesCommand_base {
