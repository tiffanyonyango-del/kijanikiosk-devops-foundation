...
declare const ListAttachedRolePoliciesCommand_base: {
    new (input: ListAttachedRolePoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListAttachedRolePoliciesCommandInput, ListAttachedRolePoliciesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListAttachedRolePoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListAttachedRolePoliciesCommandInput, ListAttachedRolePoliciesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
