...
declare const GetOutboundWebIdentityFederationInfoCommand_base: {
    new (input: GetOutboundWebIdentityFederationInfoCommandInput): import("@smithy/core/client").CommandImpl<GetOutboundWebIdentityFederationInfoCommandInput, GetOutboundWebIdentityFederationInfoCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetOutboundWebIdentityFederationInfoCommandInput]): import("@smithy/core/client").CommandImpl<GetOutboundWebIdentityFederationInfoCommandInput, GetOutboundWebIdentityFederationInfoCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
