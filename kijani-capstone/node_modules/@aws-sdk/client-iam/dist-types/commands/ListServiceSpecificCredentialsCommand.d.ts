...
declare const ListServiceSpecificCredentialsCommand_base: {
    new (input: ListServiceSpecificCredentialsCommandInput): import("@smithy/core/client").CommandImpl<ListServiceSpecificCredentialsCommandInput, ListServiceSpecificCredentialsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListServiceSpecificCredentialsCommandInput]): import("@smithy/core/client").CommandImpl<ListServiceSpecificCredentialsCommandInput, ListServiceSpecificCredentialsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
