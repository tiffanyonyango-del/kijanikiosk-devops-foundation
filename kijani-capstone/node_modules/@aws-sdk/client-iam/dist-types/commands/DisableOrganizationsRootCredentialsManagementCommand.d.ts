...
declare const DisableOrganizationsRootCredentialsManagementCommand_base: {
    new (input: DisableOrganizationsRootCredentialsManagementCommandInput): import("@smithy/core/client").CommandImpl<DisableOrganizationsRootCredentialsManagementCommandInput, DisableOrganizationsRootCredentialsManagementCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DisableOrganizationsRootCredentialsManagementCommandInput]): import("@smithy/core/client").CommandImpl<DisableOrganizationsRootCredentialsManagementCommandInput, DisableOrganizationsRootCredentialsManagementCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
