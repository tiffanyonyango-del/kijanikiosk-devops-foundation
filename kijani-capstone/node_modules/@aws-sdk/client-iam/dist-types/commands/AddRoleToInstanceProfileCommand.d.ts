...
declare const AddRoleToInstanceProfileCommand_base: {
    new (input: AddRoleToInstanceProfileCommandInput): import("@smithy/core/client").CommandImpl<AddRoleToInstanceProfileCommandInput, AddRoleToInstanceProfileCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AddRoleToInstanceProfileCommandInput): import("@smithy/core/client").CommandImpl<AddRoleToInstanceProfileCommandInput, AddRoleToInstanceProfileCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
