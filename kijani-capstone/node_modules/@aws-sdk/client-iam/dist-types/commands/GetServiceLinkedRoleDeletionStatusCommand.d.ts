...
declare const GetServiceLinkedRoleDeletionStatusCommand_base: {
    new (input: GetServiceLinkedRoleDeletionStatusCommandInput): import("@smithy/core/client").CommandImpl<GetServiceLinkedRoleDeletionStatusCommandInput, GetServiceLinkedRoleDeletionStatusCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetServiceLinkedRoleDeletionStatusCommandInput): import("@smithy/core/client").CommandImpl<GetServiceLinkedRoleDeletionStatusCommandInput, GetServiceLinkedRoleDeletionStatusCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
