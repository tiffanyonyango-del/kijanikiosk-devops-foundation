...
declare const GetRoleTemplateVersionCommand_base: {
    new (input: GetRoleTemplateVersionCommandInput): import("@smithy/core/client").CommandImpl<GetRoleTemplateVersionCommandInput, GetRoleTemplateVersionCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetRoleTemplateVersionCommandInput): import("@smithy/core/client").CommandImpl<GetRoleTemplateVersionCommandInput, GetRoleTemplateVersionCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetRoleTemplateVersionCommand extends GetRoleTemplateVersionCommand_base {
