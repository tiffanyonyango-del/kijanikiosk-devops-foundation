...
declare const ListSSHPublicKeysCommand_base: {
    new (input: ListSSHPublicKeysCommandInput): import("@smithy/core/client").CommandImpl<ListSSHPublicKeysCommandInput, ListSSHPublicKeysCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListSSHPublicKeysCommandInput]): import("@smithy/core/client").CommandImpl<ListSSHPublicKeysCommandInput, ListSSHPublicKeysCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
