...
declare const GetOpenIDConnectProviderCommand_base: {
    new (input: GetOpenIDConnectProviderCommandInput): import("@smithy/core/client").CommandImpl<GetOpenIDConnectProviderCommandInput, GetOpenIDConnectProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetOpenIDConnectProviderCommandInput): import("@smithy/core/client").CommandImpl<GetOpenIDConnectProviderCommandInput, GetOpenIDConnectProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
