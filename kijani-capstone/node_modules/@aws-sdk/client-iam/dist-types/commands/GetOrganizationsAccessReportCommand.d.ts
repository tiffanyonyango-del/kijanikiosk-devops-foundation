...
declare const GetOrganizationsAccessReportCommand_base: {
    new (input: GetOrganizationsAccessReportCommandInput): import("@smithy/core/client").CommandImpl<GetOrganizationsAccessReportCommandInput, GetOrganizationsAccessReportCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetOrganizationsAccessReportCommandInput): import("@smithy/core/client").CommandImpl<GetOrganizationsAccessReportCommandInput, GetOrganizationsAccessReportCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
