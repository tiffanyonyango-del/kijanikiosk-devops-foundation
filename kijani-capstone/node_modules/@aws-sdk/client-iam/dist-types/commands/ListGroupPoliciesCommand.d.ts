...
declare const ListGroupPoliciesCommand_base: {
    new (input: ListGroupPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListGroupPoliciesCommandInput, ListGroupPoliciesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListGroupPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListGroupPoliciesCommandInput, ListGroupPoliciesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
