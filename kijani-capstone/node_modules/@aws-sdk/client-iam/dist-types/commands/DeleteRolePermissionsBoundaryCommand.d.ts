...
declare const DeleteRolePermissionsBoundaryCommand_base: {
    new (input: DeleteRolePermissionsBoundaryCommandInput): import("@smithy/core/client").CommandImpl<DeleteRolePermissionsBoundaryCommandInput, DeleteRolePermissionsBoundaryCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteRolePermissionsBoundaryCommandInput): import("@smithy/core/client").CommandImpl<DeleteRolePermissionsBoundaryCommandInput, DeleteRolePermissionsBoundaryCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
