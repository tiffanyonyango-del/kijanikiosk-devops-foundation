...
declare const ListOpenIDConnectProvidersCommand_base: {
    new (input: ListOpenIDConnectProvidersCommandInput): import("@smithy/core/client").CommandImpl<ListOpenIDConnectProvidersCommandInput, ListOpenIDConnectProvidersCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListOpenIDConnectProvidersCommandInput]): import("@smithy/core/client").CommandImpl<ListOpenIDConnectProvidersCommandInput, ListOpenIDConnectProvidersCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
