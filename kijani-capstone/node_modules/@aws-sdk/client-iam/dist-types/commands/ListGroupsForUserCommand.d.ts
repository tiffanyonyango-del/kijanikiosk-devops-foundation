...
declare const ListGroupsForUserCommand_base: {
    new (input: ListGroupsForUserCommandInput): import("@smithy/core/client").CommandImpl<ListGroupsForUserCommandInput, ListGroupsForUserCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListGroupsForUserCommandInput): import("@smithy/core/client").CommandImpl<ListGroupsForUserCommandInput, ListGroupsForUserCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
