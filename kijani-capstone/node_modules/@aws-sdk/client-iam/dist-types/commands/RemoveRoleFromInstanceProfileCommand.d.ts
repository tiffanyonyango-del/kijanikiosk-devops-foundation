...
declare const RemoveRoleFromInstanceProfileCommand_base: {
    new (input: RemoveRoleFromInstanceProfileCommandInput): import("@smithy/core/client").CommandImpl<RemoveRoleFromInstanceProfileCommandInput, RemoveRoleFromInstanceProfileCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RemoveRoleFromInstanceProfileCommandInput): import("@smithy/core/client").CommandImpl<RemoveRoleFromInstanceProfileCommandInput, RemoveRoleFromInstanceProfileCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
