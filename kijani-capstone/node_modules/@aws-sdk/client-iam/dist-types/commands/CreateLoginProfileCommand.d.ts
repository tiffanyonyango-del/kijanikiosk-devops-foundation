...
declare const CreateLoginProfileCommand_base: {
    new (input: CreateLoginProfileCommandInput): import("@smithy/core/client").CommandImpl<CreateLoginProfileCommandInput, CreateLoginProfileCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateLoginProfileCommandInput]): import("@smithy/core/client").CommandImpl<CreateLoginProfileCommandInput, CreateLoginProfileCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
