...
declare const UpdateUserCommand_base: {
    new (input: UpdateUserCommandInput): import("@smithy/core/client").CommandImpl<UpdateUserCommandInput, UpdateUserCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateUserCommandInput): import("@smithy/core/client").CommandImpl<UpdateUserCommandInput, UpdateUserCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
