...
declare const CreateAccessKeyCommand_base: {
    new (input: CreateAccessKeyCommandInput): import("@smithy/core/client").CommandImpl<CreateAccessKeyCommandInput, CreateAccessKeyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateAccessKeyCommandInput]): import("@smithy/core/client").CommandImpl<CreateAccessKeyCommandInput, CreateAccessKeyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
