...
declare const SetSecurityTokenServicePreferencesCommand_base: {
    new (input: SetSecurityTokenServicePreferencesCommandInput): import("@smithy/core/client").CommandImpl<SetSecurityTokenServicePreferencesCommandInput, SetSecurityTokenServicePreferencesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SetSecurityTokenServicePreferencesCommandInput): import("@smithy/core/client").CommandImpl<SetSecurityTokenServicePreferencesCommandInput, SetSecurityTokenServicePreferencesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
