...
declare const ListServerCertificateTagsCommand_base: {
    new (input: ListServerCertificateTagsCommandInput): import("@smithy/core/client").CommandImpl<ListServerCertificateTagsCommandInput, ListServerCertificateTagsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListServerCertificateTagsCommandInput): import("@smithy/core/client").CommandImpl<ListServerCertificateTagsCommandInput, ListServerCertificateTagsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
