...
declare const AssociateDelegationRequestCommand_base: {
    new (input: AssociateDelegationRequestCommandInput): import("@smithy/core/client").CommandImpl<AssociateDelegationRequestCommandInput, AssociateDelegationRequestCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AssociateDelegationRequestCommandInput): import("@smithy/core/client").CommandImpl<AssociateDelegationRequestCommandInput, AssociateDelegationRequestCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
