...
declare const UntagMFADeviceCommand_base: {
    new (input: UntagMFADeviceCommandInput): import("@smithy/core/client").CommandImpl<UntagMFADeviceCommandInput, UntagMFADeviceCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UntagMFADeviceCommandInput): import("@smithy/core/client").CommandImpl<UntagMFADeviceCommandInput, UntagMFADeviceCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
