...
declare const PutGroupPolicyCommand_base: {
    new (input: PutGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutGroupPolicyCommandInput, PutGroupPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutGroupPolicyCommandInput, PutGroupPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
