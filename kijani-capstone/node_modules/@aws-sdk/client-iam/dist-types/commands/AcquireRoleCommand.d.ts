...
declare const AcquireRoleCommand_base: {
    new (input: AcquireRoleCommandInput): import("@smithy/core/client").CommandImpl<AcquireRoleCommandInput, AcquireRoleCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AcquireRoleCommandInput): import("@smithy/core/client").CommandImpl<AcquireRoleCommandInput, AcquireRoleCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
 ...
 * @public
 */
export declare class AcquireRoleCommand extends AcquireRoleCommand_base {
