...
declare const ListOrganizationsFeaturesCommand_base: {
    new (input: ListOrganizationsFeaturesCommandInput): import("@smithy/core/client").CommandImpl<ListOrganizationsFeaturesCommandInput, ListOrganizationsFeaturesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListOrganizationsFeaturesCommandInput]): import("@smithy/core/client").CommandImpl<ListOrganizationsFeaturesCommandInput, ListOrganizationsFeaturesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
