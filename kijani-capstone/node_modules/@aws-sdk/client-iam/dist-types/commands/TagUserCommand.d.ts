...
declare const TagUserCommand_base: {
    new (input: TagUserCommandInput): import("@smithy/core/client").CommandImpl<TagUserCommandInput, TagUserCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TagUserCommandInput): import("@smithy/core/client").CommandImpl<TagUserCommandInput, TagUserCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
