...
declare const GetServerCertificateCommand_base: {
    new (input: GetServerCertificateCommandInput): import("@smithy/core/client").CommandImpl<GetServerCertificateCommandInput, GetServerCertificateCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetServerCertificateCommandInput): import("@smithy/core/client").CommandImpl<GetServerCertificateCommandInput, GetServerCertificateCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
