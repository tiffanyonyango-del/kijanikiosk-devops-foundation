...
declare const ListDelegationRequestsCommand_base: {
    new (input: ListDelegationRequestsCommandInput): import("@smithy/core/client").CommandImpl<ListDelegationRequestsCommandInput, ListDelegationRequestsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListDelegationRequestsCommandInput]): import("@smithy/core/client").CommandImpl<ListDelegationRequestsCommandInput, ListDelegationRequestsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
