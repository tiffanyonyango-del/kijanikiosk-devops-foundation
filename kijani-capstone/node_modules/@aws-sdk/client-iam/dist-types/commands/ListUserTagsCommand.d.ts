...
declare const ListUserTagsCommand_base: {
    new (input: ListUserTagsCommandInput): import("@smithy/core/client").CommandImpl<ListUserTagsCommandInput, ListUserTagsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListUserTagsCommandInput): import("@smithy/core/client").CommandImpl<ListUserTagsCommandInput, ListUserTagsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
