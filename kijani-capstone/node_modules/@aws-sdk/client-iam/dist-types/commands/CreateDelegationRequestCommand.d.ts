...
declare const CreateDelegationRequestCommand_base: {
    new (input: CreateDelegationRequestCommandInput): import("@smithy/core/client").CommandImpl<CreateDelegationRequestCommandInput, CreateDelegationRequestCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateDelegationRequestCommandInput): import("@smithy/core/client").CommandImpl<CreateDelegationRequestCommandInput, CreateDelegationRequestCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
