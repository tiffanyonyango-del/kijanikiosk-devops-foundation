...
declare const UpdateLoginProfileCommand_base: {
    new (input: UpdateLoginProfileCommandInput): import("@smithy/core/client").CommandImpl<UpdateLoginProfileCommandInput, UpdateLoginProfileCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateLoginProfileCommandInput): import("@smithy/core/client").CommandImpl<UpdateLoginProfileCommandInput, UpdateLoginProfileCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
