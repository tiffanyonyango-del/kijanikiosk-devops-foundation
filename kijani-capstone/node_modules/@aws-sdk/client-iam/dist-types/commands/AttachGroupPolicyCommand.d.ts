...
declare const AttachGroupPolicyCommand_base: {
    new (input: AttachGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<AttachGroupPolicyCommandInput, AttachGroupPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AttachGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<AttachGroupPolicyCommandInput, AttachGroupPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
