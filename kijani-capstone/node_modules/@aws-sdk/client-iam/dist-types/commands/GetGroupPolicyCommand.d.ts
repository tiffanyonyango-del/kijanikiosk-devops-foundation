...
declare const GetGroupPolicyCommand_base: {
    new (input: GetGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetGroupPolicyCommandInput, GetGroupPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetGroupPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetGroupPolicyCommandInput, GetGroupPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
