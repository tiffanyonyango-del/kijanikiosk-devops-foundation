...
declare const EnableOutboundWebIdentityFederationCommand_base: {
    new (input: EnableOutboundWebIdentityFederationCommandInput): import("@smithy/core/client").CommandImpl<EnableOutboundWebIdentityFederationCommandInput, EnableOutboundWebIdentityFederationCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [EnableOutboundWebIdentityFederationCommandInput]): import("@smithy/core/client").CommandImpl<EnableOutboundWebIdentityFederationCommandInput, EnableOutboundWebIdentityFederationCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
