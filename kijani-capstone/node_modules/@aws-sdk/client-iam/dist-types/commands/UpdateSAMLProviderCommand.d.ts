...
declare const UpdateSAMLProviderCommand_base: {
    new (input: UpdateSAMLProviderCommandInput): import("@smithy/core/client").CommandImpl<UpdateSAMLProviderCommandInput, UpdateSAMLProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateSAMLProviderCommandInput): import("@smithy/core/client").CommandImpl<UpdateSAMLProviderCommandInput, UpdateSAMLProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
