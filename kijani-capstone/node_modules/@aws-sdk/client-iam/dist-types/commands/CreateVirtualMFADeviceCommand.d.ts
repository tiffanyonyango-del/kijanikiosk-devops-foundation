...
declare const CreateVirtualMFADeviceCommand_base: {
    new (input: CreateVirtualMFADeviceCommandInput): import("@smithy/core/client").CommandImpl<CreateVirtualMFADeviceCommandInput, CreateVirtualMFADeviceCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateVirtualMFADeviceCommandInput): import("@smithy/core/client").CommandImpl<CreateVirtualMFADeviceCommandInput, CreateVirtualMFADeviceCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
