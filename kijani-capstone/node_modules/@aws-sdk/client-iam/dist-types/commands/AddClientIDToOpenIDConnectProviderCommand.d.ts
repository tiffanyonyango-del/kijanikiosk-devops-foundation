...
declare const AddClientIDToOpenIDConnectProviderCommand_base: {
    new (input: AddClientIDToOpenIDConnectProviderCommandInput): import("@smithy/core/client").CommandImpl<AddClientIDToOpenIDConnectProviderCommandInput, AddClientIDToOpenIDConnectProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AddClientIDToOpenIDConnectProviderCommandInput): import("@smithy/core/client").CommandImpl<AddClientIDToOpenIDConnectProviderCommandInput, AddClientIDToOpenIDConnectProviderCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
