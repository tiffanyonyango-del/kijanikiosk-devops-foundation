...
declare const GetAccountAuthorizationDetailsCommand_base: {
    new (input: GetAccountAuthorizationDetailsCommandInput): import("@smithy/core/client").CommandImpl<GetAccountAuthorizationDetailsCommandInput, GetAccountAuthorizationDetailsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetAccountAuthorizationDetailsCommandInput]): import("@smithy/core/client").CommandImpl<GetAccountAuthorizationDetailsCommandInput, GetAccountAuthorizationDetailsCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
