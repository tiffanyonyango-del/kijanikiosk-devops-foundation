...
declare const ListUserPoliciesCommand_base: {
    new (input: ListUserPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListUserPoliciesCommandInput, ListUserPoliciesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListUserPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListUserPoliciesCommandInput, ListUserPoliciesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
