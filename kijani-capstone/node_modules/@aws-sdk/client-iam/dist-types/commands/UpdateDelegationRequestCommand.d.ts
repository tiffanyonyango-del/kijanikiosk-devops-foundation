...
declare const UpdateDelegationRequestCommand_base: {
    new (input: UpdateDelegationRequestCommandInput): import("@smithy/core/client").CommandImpl<UpdateDelegationRequestCommandInput, UpdateDelegationRequestCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateDelegationRequestCommandInput): import("@smithy/core/client").CommandImpl<UpdateDelegationRequestCommandInput, UpdateDelegationRequestCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
