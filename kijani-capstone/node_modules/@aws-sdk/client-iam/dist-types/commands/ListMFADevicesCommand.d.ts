...
declare const ListMFADevicesCommand_base: {
    new (input: ListMFADevicesCommandInput): import("@smithy/core/client").CommandImpl<ListMFADevicesCommandInput, ListMFADevicesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListMFADevicesCommandInput]): import("@smithy/core/client").CommandImpl<ListMFADevicesCommandInput, ListMFADevicesCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
