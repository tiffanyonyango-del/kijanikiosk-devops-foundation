...
declare const AttachUserPolicyCommand_base: {
    new (input: AttachUserPolicyCommandInput): import("@smithy/core/client").CommandImpl<AttachUserPolicyCommandInput, AttachUserPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: AttachUserPolicyCommandInput): import("@smithy/core/client").CommandImpl<AttachUserPolicyCommandInput, AttachUserPolicyCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
