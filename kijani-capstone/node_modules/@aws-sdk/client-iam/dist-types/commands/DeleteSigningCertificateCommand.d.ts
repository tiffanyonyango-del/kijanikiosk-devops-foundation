...
declare const DeleteSigningCertificateCommand_base: {
    new (input: DeleteSigningCertificateCommandInput): import("@smithy/core/client").CommandImpl<DeleteSigningCertificateCommandInput, DeleteSigningCertificateCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteSigningCertificateCommandInput): import("@smithy/core/client").CommandImpl<DeleteSigningCertificateCommandInput, DeleteSigningCertificateCommandOutput, import("..").IAMClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
