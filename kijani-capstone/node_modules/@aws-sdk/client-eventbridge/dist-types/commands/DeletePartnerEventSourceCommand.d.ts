...
declare const DeletePartnerEventSourceCommand_base: {
    new (input: DeletePartnerEventSourceCommandInput): import("@smithy/core/client").CommandImpl<DeletePartnerEventSourceCommandInput, DeletePartnerEventSourceCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeletePartnerEventSourceCommandInput): import("@smithy/core/client").CommandImpl<DeletePartnerEventSourceCommandInput, DeletePartnerEventSourceCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
