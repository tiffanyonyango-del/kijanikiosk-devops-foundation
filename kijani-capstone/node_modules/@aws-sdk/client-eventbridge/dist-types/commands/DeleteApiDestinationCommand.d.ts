...
declare const DeleteApiDestinationCommand_base: {
    new (input: DeleteApiDestinationCommandInput): import("@smithy/core/client").CommandImpl<DeleteApiDestinationCommandInput, DeleteApiDestinationCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteApiDestinationCommandInput): import("@smithy/core/client").CommandImpl<DeleteApiDestinationCommandInput, DeleteApiDestinationCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
