...
declare const ListPartnerEventSourceAccountsCommand_base: {
    new (input: ListPartnerEventSourceAccountsCommandInput): import("@smithy/core/client").CommandImpl<ListPartnerEventSourceAccountsCommandInput, ListPartnerEventSourceAccountsCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListPartnerEventSourceAccountsCommandInput): import("@smithy/core/client").CommandImpl<ListPartnerEventSourceAccountsCommandInput, ListPartnerEventSourceAccountsCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
