...
declare const CreateApiDestinationCommand_base: {
    new (input: CreateApiDestinationCommandInput): import("@smithy/core/client").CommandImpl<CreateApiDestinationCommandInput, CreateApiDestinationCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateApiDestinationCommandInput): import("@smithy/core/client").CommandImpl<CreateApiDestinationCommandInput, CreateApiDestinationCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
