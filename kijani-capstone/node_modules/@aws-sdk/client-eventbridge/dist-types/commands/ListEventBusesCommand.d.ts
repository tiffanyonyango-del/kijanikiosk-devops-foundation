...
declare const ListEventBusesCommand_base: {
    new (input: ListEventBusesCommandInput): import("@smithy/core/client").CommandImpl<ListEventBusesCommandInput, ListEventBusesCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListEventBusesCommandInput]): import("@smithy/core/client").CommandImpl<ListEventBusesCommandInput, ListEventBusesCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
