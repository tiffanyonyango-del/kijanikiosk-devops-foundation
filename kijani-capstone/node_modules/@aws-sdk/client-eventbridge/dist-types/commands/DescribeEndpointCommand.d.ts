...
declare const DescribeEndpointCommand_base: {
    new (input: DescribeEndpointCommandInput): import("@smithy/core/client").CommandImpl<DescribeEndpointCommandInput, DescribeEndpointCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeEndpointCommandInput): import("@smithy/core/client").CommandImpl<DescribeEndpointCommandInput, DescribeEndpointCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
