...
declare const TestEventPatternCommand_base: {
    new (input: TestEventPatternCommandInput): import("@smithy/core/client").CommandImpl<TestEventPatternCommandInput, TestEventPatternCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: TestEventPatternCommandInput): import("@smithy/core/client").CommandImpl<TestEventPatternCommandInput, TestEventPatternCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
