...
declare const ListEventSourcesCommand_base: {
    new (input: ListEventSourcesCommandInput): import("@smithy/core/client").CommandImpl<ListEventSourcesCommandInput, ListEventSourcesCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListEventSourcesCommandInput]): import("@smithy/core/client").CommandImpl<ListEventSourcesCommandInput, ListEventSourcesCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
