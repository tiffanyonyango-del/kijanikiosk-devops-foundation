...
declare const RemovePermissionCommand_base: {
    new (input: RemovePermissionCommandInput): import("@smithy/core/client").CommandImpl<RemovePermissionCommandInput, RemovePermissionCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [RemovePermissionCommandInput]): import("@smithy/core/client").CommandImpl<RemovePermissionCommandInput, RemovePermissionCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
