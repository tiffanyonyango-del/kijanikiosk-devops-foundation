...
declare const ListArchivesCommand_base: {
    new (input: ListArchivesCommandInput): import("@smithy/core/client").CommandImpl<ListArchivesCommandInput, ListArchivesCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListArchivesCommandInput]): import("@smithy/core/client").CommandImpl<ListArchivesCommandInput, ListArchivesCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
