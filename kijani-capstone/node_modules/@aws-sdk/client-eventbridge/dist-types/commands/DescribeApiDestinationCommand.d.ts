...
declare const DescribeApiDestinationCommand_base: {
    new (input: DescribeApiDestinationCommandInput): import("@smithy/core/client").CommandImpl<DescribeApiDestinationCommandInput, DescribeApiDestinationCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeApiDestinationCommandInput): import("@smithy/core/client").CommandImpl<DescribeApiDestinationCommandInput, DescribeApiDestinationCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
