...
declare const DeauthorizeConnectionCommand_base: {
    new (input: DeauthorizeConnectionCommandInput): import("@smithy/core/client").CommandImpl<DeauthorizeConnectionCommandInput, DeauthorizeConnectionCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeauthorizeConnectionCommandInput): import("@smithy/core/client").CommandImpl<DeauthorizeConnectionCommandInput, DeauthorizeConnectionCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
