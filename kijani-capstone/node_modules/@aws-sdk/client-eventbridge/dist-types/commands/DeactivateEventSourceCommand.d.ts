...
declare const DeactivateEventSourceCommand_base: {
    new (input: DeactivateEventSourceCommandInput): import("@smithy/core/client").CommandImpl<DeactivateEventSourceCommandInput, DeactivateEventSourceCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeactivateEventSourceCommandInput): import("@smithy/core/client").CommandImpl<DeactivateEventSourceCommandInput, DeactivateEventSourceCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
