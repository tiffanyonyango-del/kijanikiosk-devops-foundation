...
declare const DescribeReplayCommand_base: {
    new (input: DescribeReplayCommandInput): import("@smithy/core/client").CommandImpl<DescribeReplayCommandInput, DescribeReplayCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeReplayCommandInput): import("@smithy/core/client").CommandImpl<DescribeReplayCommandInput, DescribeReplayCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
