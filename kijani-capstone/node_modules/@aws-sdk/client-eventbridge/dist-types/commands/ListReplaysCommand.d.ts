...
declare const ListReplaysCommand_base: {
    new (input: ListReplaysCommandInput): import("@smithy/core/client").CommandImpl<ListReplaysCommandInput, ListReplaysCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListReplaysCommandInput]): import("@smithy/core/client").CommandImpl<ListReplaysCommandInput, ListReplaysCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
