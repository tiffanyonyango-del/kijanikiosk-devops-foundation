...
declare const ListPartnerEventSourcesCommand_base: {
    new (input: ListPartnerEventSourcesCommandInput): import("@smithy/core/client").CommandImpl<ListPartnerEventSourcesCommandInput, ListPartnerEventSourcesCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListPartnerEventSourcesCommandInput): import("@smithy/core/client").CommandImpl<ListPartnerEventSourcesCommandInput, ListPartnerEventSourcesCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
