...
declare const ListRulesCommand_base: {
    new (input: ListRulesCommandInput): import("@smithy/core/client").CommandImpl<ListRulesCommandInput, ListRulesCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListRulesCommandInput]): import("@smithy/core/client").CommandImpl<ListRulesCommandInput, ListRulesCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
