...
declare const DeleteArchiveCommand_base: {
    new (input: DeleteArchiveCommandInput): import("@smithy/core/client").CommandImpl<DeleteArchiveCommandInput, DeleteArchiveCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteArchiveCommandInput): import("@smithy/core/client").CommandImpl<DeleteArchiveCommandInput, DeleteArchiveCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
