...
declare const DescribeArchiveCommand_base: {
    new (input: DescribeArchiveCommandInput): import("@smithy/core/client").CommandImpl<DescribeArchiveCommandInput, DescribeArchiveCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeArchiveCommandInput): import("@smithy/core/client").CommandImpl<DescribeArchiveCommandInput, DescribeArchiveCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
