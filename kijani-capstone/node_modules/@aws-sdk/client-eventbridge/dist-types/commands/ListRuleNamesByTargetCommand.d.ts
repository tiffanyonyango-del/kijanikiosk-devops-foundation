...
declare const ListRuleNamesByTargetCommand_base: {
    new (input: ListRuleNamesByTargetCommandInput): import("@smithy/core/client").CommandImpl<ListRuleNamesByTargetCommandInput, ListRuleNamesByTargetCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListRuleNamesByTargetCommandInput): import("@smithy/core/client").CommandImpl<ListRuleNamesByTargetCommandInput, ListRuleNamesByTargetCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
