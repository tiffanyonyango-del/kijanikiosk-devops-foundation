...
declare const RemoveTargetsCommand_base: {
    new (input: RemoveTargetsCommandInput): import("@smithy/core/client").CommandImpl<RemoveTargetsCommandInput, RemoveTargetsCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RemoveTargetsCommandInput): import("@smithy/core/client").CommandImpl<RemoveTargetsCommandInput, RemoveTargetsCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
