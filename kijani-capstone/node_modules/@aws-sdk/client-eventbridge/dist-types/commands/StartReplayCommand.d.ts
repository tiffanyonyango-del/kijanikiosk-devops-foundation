...
declare const StartReplayCommand_base: {
    new (input: StartReplayCommandInput): import("@smithy/core/client").CommandImpl<StartReplayCommandInput, StartReplayCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartReplayCommandInput): import("@smithy/core/client").CommandImpl<StartReplayCommandInput, StartReplayCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
