...
declare const CreatePartnerEventSourceCommand_base: {
    new (input: CreatePartnerEventSourceCommandInput): import("@smithy/core/client").CommandImpl<CreatePartnerEventSourceCommandInput, CreatePartnerEventSourceCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePartnerEventSourceCommandInput): import("@smithy/core/client").CommandImpl<CreatePartnerEventSourceCommandInput, CreatePartnerEventSourceCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
