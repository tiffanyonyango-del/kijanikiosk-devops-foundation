...
declare const CreateArchiveCommand_base: {
    new (input: CreateArchiveCommandInput): import("@smithy/core/client").CommandImpl<CreateArchiveCommandInput, CreateArchiveCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateArchiveCommandInput): import("@smithy/core/client").CommandImpl<CreateArchiveCommandInput, CreateArchiveCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
