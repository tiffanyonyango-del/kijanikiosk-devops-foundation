...
declare const UpdateArchiveCommand_base: {
    new (input: UpdateArchiveCommandInput): import("@smithy/core/client").CommandImpl<UpdateArchiveCommandInput, UpdateArchiveCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateArchiveCommandInput): import("@smithy/core/client").CommandImpl<UpdateArchiveCommandInput, UpdateArchiveCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
