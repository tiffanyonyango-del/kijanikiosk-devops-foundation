...
declare const ListTargetsByRuleCommand_base: {
    new (input: ListTargetsByRuleCommandInput): import("@smithy/core/client").CommandImpl<ListTargetsByRuleCommandInput, ListTargetsByRuleCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListTargetsByRuleCommandInput): import("@smithy/core/client").CommandImpl<ListTargetsByRuleCommandInput, ListTargetsByRuleCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
