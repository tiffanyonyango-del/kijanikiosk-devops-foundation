...
declare const PutPartnerEventsCommand_base: {
    new (input: PutPartnerEventsCommandInput): import("@smithy/core/client").CommandImpl<PutPartnerEventsCommandInput, PutPartnerEventsCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutPartnerEventsCommandInput): import("@smithy/core/client").CommandImpl<PutPartnerEventsCommandInput, PutPartnerEventsCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
