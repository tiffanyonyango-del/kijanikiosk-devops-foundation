...
declare const PutRuleCommand_base: {
    new (input: PutRuleCommandInput): import("@smithy/core/client").CommandImpl<PutRuleCommandInput, PutRuleCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutRuleCommandInput): import("@smithy/core/client").CommandImpl<PutRuleCommandInput, PutRuleCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
