...
declare const DescribeEventSourceCommand_base: {
    new (input: DescribeEventSourceCommandInput): import("@smithy/core/client").CommandImpl<DescribeEventSourceCommandInput, DescribeEventSourceCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeEventSourceCommandInput): import("@smithy/core/client").CommandImpl<DescribeEventSourceCommandInput, DescribeEventSourceCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
