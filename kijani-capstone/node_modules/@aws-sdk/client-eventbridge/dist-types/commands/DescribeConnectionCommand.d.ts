...
declare const DescribeConnectionCommand_base: {
    new (input: DescribeConnectionCommandInput): import("@smithy/core/client").CommandImpl<DescribeConnectionCommandInput, DescribeConnectionCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeConnectionCommandInput): import("@smithy/core/client").CommandImpl<DescribeConnectionCommandInput, DescribeConnectionCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
