...
declare const PutTargetsCommand_base: {
    new (input: PutTargetsCommandInput): import("@smithy/core/client").CommandImpl<PutTargetsCommandInput, PutTargetsCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutTargetsCommandInput): import("@smithy/core/client").CommandImpl<PutTargetsCommandInput, PutTargetsCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
