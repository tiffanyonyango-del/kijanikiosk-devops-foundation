...
declare const DescribeEventBusCommand_base: {
    new (input: DescribeEventBusCommandInput): import("@smithy/core/client").CommandImpl<DescribeEventBusCommandInput, DescribeEventBusCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeEventBusCommandInput]): import("@smithy/core/client").CommandImpl<DescribeEventBusCommandInput, DescribeEventBusCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
