...
declare const CreateEventBusCommand_base: {
    new (input: CreateEventBusCommandInput): import("@smithy/core/client").CommandImpl<CreateEventBusCommandInput, CreateEventBusCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateEventBusCommandInput): import("@smithy/core/client").CommandImpl<CreateEventBusCommandInput, CreateEventBusCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
