...
declare const DeleteEventBusCommand_base: {
    new (input: DeleteEventBusCommandInput): import("@smithy/core/client").CommandImpl<DeleteEventBusCommandInput, DeleteEventBusCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteEventBusCommandInput): import("@smithy/core/client").CommandImpl<DeleteEventBusCommandInput, DeleteEventBusCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
