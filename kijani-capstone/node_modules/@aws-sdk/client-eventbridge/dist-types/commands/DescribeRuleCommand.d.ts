...
declare const DescribeRuleCommand_base: {
    new (input: DescribeRuleCommandInput): import("@smithy/core/client").CommandImpl<DescribeRuleCommandInput, DescribeRuleCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeRuleCommandInput): import("@smithy/core/client").CommandImpl<DescribeRuleCommandInput, DescribeRuleCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
