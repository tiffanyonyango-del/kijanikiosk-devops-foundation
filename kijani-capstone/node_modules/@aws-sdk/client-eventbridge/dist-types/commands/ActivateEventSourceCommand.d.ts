...
declare const ActivateEventSourceCommand_base: {
    new (input: ActivateEventSourceCommandInput): import("@smithy/core/client").CommandImpl<ActivateEventSourceCommandInput, ActivateEventSourceCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ActivateEventSourceCommandInput): import("@smithy/core/client").CommandImpl<ActivateEventSourceCommandInput, ActivateEventSourceCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
