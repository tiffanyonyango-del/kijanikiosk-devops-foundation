...
declare const UpdateEventBusCommand_base: {
    new (input: UpdateEventBusCommandInput): import("@smithy/core/client").CommandImpl<UpdateEventBusCommandInput, UpdateEventBusCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [UpdateEventBusCommandInput]): import("@smithy/core/client").CommandImpl<UpdateEventBusCommandInput, UpdateEventBusCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
