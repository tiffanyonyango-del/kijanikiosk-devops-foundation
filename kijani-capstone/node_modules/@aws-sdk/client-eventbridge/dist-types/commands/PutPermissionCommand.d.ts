...
declare const PutPermissionCommand_base: {
    new (input: PutPermissionCommandInput): import("@smithy/core/client").CommandImpl<PutPermissionCommandInput, PutPermissionCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [PutPermissionCommandInput]): import("@smithy/core/client").CommandImpl<PutPermissionCommandInput, PutPermissionCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
