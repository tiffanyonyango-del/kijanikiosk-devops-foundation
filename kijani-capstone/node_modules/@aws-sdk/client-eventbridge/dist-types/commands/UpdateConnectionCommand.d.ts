...
declare const UpdateConnectionCommand_base: {
    new (input: UpdateConnectionCommandInput): import("@smithy/core/client").CommandImpl<UpdateConnectionCommandInput, UpdateConnectionCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateConnectionCommandInput): import("@smithy/core/client").CommandImpl<UpdateConnectionCommandInput, UpdateConnectionCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
