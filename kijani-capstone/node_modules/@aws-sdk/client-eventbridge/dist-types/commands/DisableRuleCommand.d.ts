...
declare const DisableRuleCommand_base: {
    new (input: DisableRuleCommandInput): import("@smithy/core/client").CommandImpl<DisableRuleCommandInput, DisableRuleCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisableRuleCommandInput): import("@smithy/core/client").CommandImpl<DisableRuleCommandInput, DisableRuleCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
