...
declare const CancelReplayCommand_base: {
    new (input: CancelReplayCommandInput): import("@smithy/core/client").CommandImpl<CancelReplayCommandInput, CancelReplayCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CancelReplayCommandInput): import("@smithy/core/client").CommandImpl<CancelReplayCommandInput, CancelReplayCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
