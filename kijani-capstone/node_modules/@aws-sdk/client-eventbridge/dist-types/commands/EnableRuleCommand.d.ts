...
declare const EnableRuleCommand_base: {
    new (input: EnableRuleCommandInput): import("@smithy/core/client").CommandImpl<EnableRuleCommandInput, EnableRuleCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: EnableRuleCommandInput): import("@smithy/core/client").CommandImpl<EnableRuleCommandInput, EnableRuleCommandOutput, import("..").EventBridgeClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
