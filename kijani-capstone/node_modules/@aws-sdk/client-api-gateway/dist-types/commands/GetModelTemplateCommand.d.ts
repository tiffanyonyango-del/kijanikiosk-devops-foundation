...
declare const GetModelTemplateCommand_base: {
    new (input: GetModelTemplateCommandInput): import("@smithy/core/client").CommandImpl<GetModelTemplateCommandInput, GetModelTemplateCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetModelTemplateCommandInput): import("@smithy/core/client").CommandImpl<GetModelTemplateCommandInput, GetModelTemplateCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
