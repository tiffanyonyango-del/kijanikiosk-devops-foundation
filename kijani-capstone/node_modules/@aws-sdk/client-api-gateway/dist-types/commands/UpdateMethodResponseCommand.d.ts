...
declare const UpdateMethodResponseCommand_base: {
    new (input: UpdateMethodResponseCommandInput): import("@smithy/core/client").CommandImpl<UpdateMethodResponseCommandInput, UpdateMethodResponseCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateMethodResponseCommandInput): import("@smithy/core/client").CommandImpl<UpdateMethodResponseCommandInput, UpdateMethodResponseCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
