...
declare const GetAccountCommand_base: {
    new (input: GetAccountCommandInput): import("@smithy/core/client").CommandImpl<GetAccountCommandInput, GetAccountCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetAccountCommandInput]): import("@smithy/core/client").CommandImpl<GetAccountCommandInput, GetAccountCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
