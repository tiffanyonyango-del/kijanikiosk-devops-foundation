...
declare const GetUsageCommand_base: {
    new (input: GetUsageCommandInput): import("@smithy/core/client").CommandImpl<GetUsageCommandInput, GetUsageCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetUsageCommandInput): import("@smithy/core/client").CommandImpl<GetUsageCommandInput, GetUsageCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
