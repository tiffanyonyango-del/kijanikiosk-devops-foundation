...
declare const GetApiKeysCommand_base: {
    new (input: GetApiKeysCommandInput): import("@smithy/core/client").CommandImpl<GetApiKeysCommandInput, GetApiKeysCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetApiKeysCommandInput]): import("@smithy/core/client").CommandImpl<GetApiKeysCommandInput, GetApiKeysCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
