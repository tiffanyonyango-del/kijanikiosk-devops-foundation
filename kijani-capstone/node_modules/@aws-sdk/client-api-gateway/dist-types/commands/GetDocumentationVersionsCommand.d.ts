...
declare const GetDocumentationVersionsCommand_base: {
    new (input: GetDocumentationVersionsCommandInput): import("@smithy/core/client").CommandImpl<GetDocumentationVersionsCommandInput, GetDocumentationVersionsCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDocumentationVersionsCommandInput): import("@smithy/core/client").CommandImpl<GetDocumentationVersionsCommandInput, GetDocumentationVersionsCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
