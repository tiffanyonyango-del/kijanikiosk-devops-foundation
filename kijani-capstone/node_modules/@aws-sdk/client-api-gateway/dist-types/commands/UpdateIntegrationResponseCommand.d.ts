...
declare const UpdateIntegrationResponseCommand_base: {
    new (input: UpdateIntegrationResponseCommandInput): import("@smithy/core/client").CommandImpl<UpdateIntegrationResponseCommandInput, UpdateIntegrationResponseCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateIntegrationResponseCommandInput): import("@smithy/core/client").CommandImpl<UpdateIntegrationResponseCommandInput, UpdateIntegrationResponseCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
