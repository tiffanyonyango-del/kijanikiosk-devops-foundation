...
declare const UpdateDocumentationPartCommand_base: {
    new (input: UpdateDocumentationPartCommandInput): import("@smithy/core/client").CommandImpl<UpdateDocumentationPartCommandInput, UpdateDocumentationPartCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateDocumentationPartCommandInput): import("@smithy/core/client").CommandImpl<UpdateDocumentationPartCommandInput, UpdateDocumentationPartCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
