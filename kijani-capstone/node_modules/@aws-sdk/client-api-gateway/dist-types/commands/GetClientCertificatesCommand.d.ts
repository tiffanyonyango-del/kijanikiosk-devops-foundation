...
declare const GetClientCertificatesCommand_base: {
    new (input: GetClientCertificatesCommandInput): import("@smithy/core/client").CommandImpl<GetClientCertificatesCommandInput, GetClientCertificatesCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetClientCertificatesCommandInput]): import("@smithy/core/client").CommandImpl<GetClientCertificatesCommandInput, GetClientCertificatesCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
