...
declare const GenerateClientCertificateCommand_base: {
    new (input: GenerateClientCertificateCommandInput): import("@smithy/core/client").CommandImpl<GenerateClientCertificateCommandInput, GenerateClientCertificateCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GenerateClientCertificateCommandInput]): import("@smithy/core/client").CommandImpl<GenerateClientCertificateCommandInput, GenerateClientCertificateCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
