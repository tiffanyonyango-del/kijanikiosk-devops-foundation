...
declare const UpdateResourceCommand_base: {
    new (input: UpdateResourceCommandInput): import("@smithy/core/client").CommandImpl<UpdateResourceCommandInput, UpdateResourceCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateResourceCommandInput): import("@smithy/core/client").CommandImpl<UpdateResourceCommandInput, UpdateResourceCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
