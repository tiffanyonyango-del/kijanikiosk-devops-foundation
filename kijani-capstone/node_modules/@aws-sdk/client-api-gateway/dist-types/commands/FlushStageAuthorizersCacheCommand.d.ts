...
declare const FlushStageAuthorizersCacheCommand_base: {
    new (input: FlushStageAuthorizersCacheCommandInput): import("@smithy/core/client").CommandImpl<FlushStageAuthorizersCacheCommandInput, FlushStageAuthorizersCacheCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: FlushStageAuthorizersCacheCommandInput): import("@smithy/core/client").CommandImpl<FlushStageAuthorizersCacheCommandInput, FlushStageAuthorizersCacheCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
