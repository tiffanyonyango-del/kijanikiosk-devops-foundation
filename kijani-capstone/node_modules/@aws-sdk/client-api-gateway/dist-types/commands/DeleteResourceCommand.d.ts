...
declare const DeleteResourceCommand_base: {
    new (input: DeleteResourceCommandInput): import("@smithy/core/client").CommandImpl<DeleteResourceCommandInput, DeleteResourceCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteResourceCommandInput): import("@smithy/core/client").CommandImpl<DeleteResourceCommandInput, DeleteResourceCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
