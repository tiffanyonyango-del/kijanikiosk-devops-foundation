...
declare const DeleteUsagePlanKeyCommand_base: {
    new (input: DeleteUsagePlanKeyCommandInput): import("@smithy/core/client").CommandImpl<DeleteUsagePlanKeyCommandInput, DeleteUsagePlanKeyCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteUsagePlanKeyCommandInput): import("@smithy/core/client").CommandImpl<DeleteUsagePlanKeyCommandInput, DeleteUsagePlanKeyCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
