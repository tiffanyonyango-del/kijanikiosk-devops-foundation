...
declare const UpdateMethodCommand_base: {
    new (input: UpdateMethodCommandInput): import("@smithy/core/client").CommandImpl<UpdateMethodCommandInput, UpdateMethodCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateMethodCommandInput): import("@smithy/core/client").CommandImpl<UpdateMethodCommandInput, UpdateMethodCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
