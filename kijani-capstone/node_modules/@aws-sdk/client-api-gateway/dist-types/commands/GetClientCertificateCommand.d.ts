...
declare const GetClientCertificateCommand_base: {
    new (input: GetClientCertificateCommandInput): import("@smithy/core/client").CommandImpl<GetClientCertificateCommandInput, GetClientCertificateCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetClientCertificateCommandInput): import("@smithy/core/client").CommandImpl<GetClientCertificateCommandInput, GetClientCertificateCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
