...
declare const GetRequestValidatorsCommand_base: {
    new (input: GetRequestValidatorsCommandInput): import("@smithy/core/client").CommandImpl<GetRequestValidatorsCommandInput, GetRequestValidatorsCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetRequestValidatorsCommandInput): import("@smithy/core/client").CommandImpl<GetRequestValidatorsCommandInput, GetRequestValidatorsCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
