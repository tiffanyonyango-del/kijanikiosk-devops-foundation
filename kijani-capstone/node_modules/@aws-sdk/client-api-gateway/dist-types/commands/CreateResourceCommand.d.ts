...
declare const CreateResourceCommand_base: {
    new (input: CreateResourceCommandInput): import("@smithy/core/client").CommandImpl<CreateResourceCommandInput, CreateResourceCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateResourceCommandInput): import("@smithy/core/client").CommandImpl<CreateResourceCommandInput, CreateResourceCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
