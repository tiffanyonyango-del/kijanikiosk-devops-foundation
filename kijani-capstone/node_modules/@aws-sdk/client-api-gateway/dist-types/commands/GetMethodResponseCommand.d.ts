...
declare const GetMethodResponseCommand_base: {
    new (input: GetMethodResponseCommandInput): import("@smithy/core/client").CommandImpl<GetMethodResponseCommandInput, GetMethodResponseCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetMethodResponseCommandInput): import("@smithy/core/client").CommandImpl<GetMethodResponseCommandInput, GetMethodResponseCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
