...
declare const UpdateUsagePlanCommand_base: {
    new (input: UpdateUsagePlanCommandInput): import("@smithy/core/client").CommandImpl<UpdateUsagePlanCommandInput, UpdateUsagePlanCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateUsagePlanCommandInput): import("@smithy/core/client").CommandImpl<UpdateUsagePlanCommandInput, UpdateUsagePlanCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
