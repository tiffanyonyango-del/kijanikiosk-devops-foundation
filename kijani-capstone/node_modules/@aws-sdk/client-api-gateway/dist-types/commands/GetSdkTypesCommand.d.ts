...
declare const GetSdkTypesCommand_base: {
    new (input: GetSdkTypesCommandInput): import("@smithy/core/client").CommandImpl<GetSdkTypesCommandInput, GetSdkTypesCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetSdkTypesCommandInput]): import("@smithy/core/client").CommandImpl<GetSdkTypesCommandInput, GetSdkTypesCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
