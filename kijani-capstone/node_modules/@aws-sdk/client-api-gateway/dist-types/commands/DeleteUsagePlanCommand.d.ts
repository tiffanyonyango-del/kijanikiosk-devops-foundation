...
declare const DeleteUsagePlanCommand_base: {
    new (input: DeleteUsagePlanCommandInput): import("@smithy/core/client").CommandImpl<DeleteUsagePlanCommandInput, DeleteUsagePlanCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteUsagePlanCommandInput): import("@smithy/core/client").CommandImpl<DeleteUsagePlanCommandInput, DeleteUsagePlanCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
