...
declare const GetBasePathMappingCommand_base: {
    new (input: GetBasePathMappingCommandInput): import("@smithy/core/client").CommandImpl<GetBasePathMappingCommandInput, GetBasePathMappingCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetBasePathMappingCommandInput): import("@smithy/core/client").CommandImpl<GetBasePathMappingCommandInput, GetBasePathMappingCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
