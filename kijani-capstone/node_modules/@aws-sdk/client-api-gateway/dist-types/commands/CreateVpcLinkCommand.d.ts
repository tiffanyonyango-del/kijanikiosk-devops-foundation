...
declare const CreateVpcLinkCommand_base: {
    new (input: CreateVpcLinkCommandInput): import("@smithy/core/client").CommandImpl<CreateVpcLinkCommandInput, CreateVpcLinkCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateVpcLinkCommandInput): import("@smithy/core/client").CommandImpl<CreateVpcLinkCommandInput, CreateVpcLinkCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
