...
declare const CreateRequestValidatorCommand_base: {
    new (input: CreateRequestValidatorCommandInput): import("@smithy/core/client").CommandImpl<CreateRequestValidatorCommandInput, CreateRequestValidatorCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateRequestValidatorCommandInput): import("@smithy/core/client").CommandImpl<CreateRequestValidatorCommandInput, CreateRequestValidatorCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
