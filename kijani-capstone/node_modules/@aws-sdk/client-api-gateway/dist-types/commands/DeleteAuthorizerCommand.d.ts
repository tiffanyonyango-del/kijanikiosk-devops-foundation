...
declare const DeleteAuthorizerCommand_base: {
    new (input: DeleteAuthorizerCommandInput): import("@smithy/core/client").CommandImpl<DeleteAuthorizerCommandInput, DeleteAuthorizerCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteAuthorizerCommandInput): import("@smithy/core/client").CommandImpl<DeleteAuthorizerCommandInput, DeleteAuthorizerCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
