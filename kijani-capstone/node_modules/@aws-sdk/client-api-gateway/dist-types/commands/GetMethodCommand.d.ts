...
declare const GetMethodCommand_base: {
    new (input: GetMethodCommandInput): import("@smithy/core/client").CommandImpl<GetMethodCommandInput, GetMethodCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetMethodCommandInput): import("@smithy/core/client").CommandImpl<GetMethodCommandInput, GetMethodCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
