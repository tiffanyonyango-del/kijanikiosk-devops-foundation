...
declare const UpdateVpcLinkCommand_base: {
    new (input: UpdateVpcLinkCommandInput): import("@smithy/core/client").CommandImpl<UpdateVpcLinkCommandInput, UpdateVpcLinkCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateVpcLinkCommandInput): import("@smithy/core/client").CommandImpl<UpdateVpcLinkCommandInput, UpdateVpcLinkCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
