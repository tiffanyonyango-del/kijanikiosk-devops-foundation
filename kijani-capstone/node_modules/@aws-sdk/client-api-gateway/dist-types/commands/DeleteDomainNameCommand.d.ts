...
declare const DeleteDomainNameCommand_base: {
    new (input: DeleteDomainNameCommandInput): import("@smithy/core/client").CommandImpl<DeleteDomainNameCommandInput, DeleteDomainNameCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDomainNameCommandInput): import("@smithy/core/client").CommandImpl<DeleteDomainNameCommandInput, DeleteDomainNameCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
