...
declare const CreateDocumentationPartCommand_base: {
    new (input: CreateDocumentationPartCommandInput): import("@smithy/core/client").CommandImpl<CreateDocumentationPartCommandInput, CreateDocumentationPartCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateDocumentationPartCommandInput): import("@smithy/core/client").CommandImpl<CreateDocumentationPartCommandInput, CreateDocumentationPartCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
