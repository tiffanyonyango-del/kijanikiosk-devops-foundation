...
declare const GetStageCommand_base: {
    new (input: GetStageCommandInput): import("@smithy/core/client").CommandImpl<GetStageCommandInput, GetStageCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetStageCommandInput): import("@smithy/core/client").CommandImpl<GetStageCommandInput, GetStageCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
