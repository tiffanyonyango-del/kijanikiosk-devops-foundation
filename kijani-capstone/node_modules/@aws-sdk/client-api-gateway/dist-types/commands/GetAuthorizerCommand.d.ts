...
declare const GetAuthorizerCommand_base: {
    new (input: GetAuthorizerCommandInput): import("@smithy/core/client").CommandImpl<GetAuthorizerCommandInput, GetAuthorizerCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetAuthorizerCommandInput): import("@smithy/core/client").CommandImpl<GetAuthorizerCommandInput, GetAuthorizerCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
