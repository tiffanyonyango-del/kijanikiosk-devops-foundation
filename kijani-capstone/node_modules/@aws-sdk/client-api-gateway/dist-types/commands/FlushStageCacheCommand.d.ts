...
declare const FlushStageCacheCommand_base: {
    new (input: FlushStageCacheCommandInput): import("@smithy/core/client").CommandImpl<FlushStageCacheCommandInput, FlushStageCacheCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: FlushStageCacheCommandInput): import("@smithy/core/client").CommandImpl<FlushStageCacheCommandInput, FlushStageCacheCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
