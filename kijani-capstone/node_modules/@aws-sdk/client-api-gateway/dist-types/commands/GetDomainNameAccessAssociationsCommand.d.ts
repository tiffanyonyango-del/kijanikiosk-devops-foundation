...
declare const GetDomainNameAccessAssociationsCommand_base: {
    new (input: GetDomainNameAccessAssociationsCommandInput): import("@smithy/core/client").CommandImpl<GetDomainNameAccessAssociationsCommandInput, GetDomainNameAccessAssociationsCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetDomainNameAccessAssociationsCommandInput]): import("@smithy/core/client").CommandImpl<GetDomainNameAccessAssociationsCommandInput, GetDomainNameAccessAssociationsCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
