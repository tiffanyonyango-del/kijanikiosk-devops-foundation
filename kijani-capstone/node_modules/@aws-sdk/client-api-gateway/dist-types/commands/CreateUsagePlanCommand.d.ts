...
declare const CreateUsagePlanCommand_base: {
    new (input: CreateUsagePlanCommandInput): import("@smithy/core/client").CommandImpl<CreateUsagePlanCommandInput, CreateUsagePlanCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateUsagePlanCommandInput): import("@smithy/core/client").CommandImpl<CreateUsagePlanCommandInput, CreateUsagePlanCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
