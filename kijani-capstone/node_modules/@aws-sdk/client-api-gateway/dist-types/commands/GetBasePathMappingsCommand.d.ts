...
declare const GetBasePathMappingsCommand_base: {
    new (input: GetBasePathMappingsCommandInput): import("@smithy/core/client").CommandImpl<GetBasePathMappingsCommandInput, GetBasePathMappingsCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetBasePathMappingsCommandInput): import("@smithy/core/client").CommandImpl<GetBasePathMappingsCommandInput, GetBasePathMappingsCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
