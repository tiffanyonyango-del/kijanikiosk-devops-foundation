...
declare const CreateBasePathMappingCommand_base: {
    new (input: CreateBasePathMappingCommandInput): import("@smithy/core/client").CommandImpl<CreateBasePathMappingCommandInput, CreateBasePathMappingCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateBasePathMappingCommandInput): import("@smithy/core/client").CommandImpl<CreateBasePathMappingCommandInput, CreateBasePathMappingCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
