...
declare const GetDocumentationPartCommand_base: {
    new (input: GetDocumentationPartCommandInput): import("@smithy/core/client").CommandImpl<GetDocumentationPartCommandInput, GetDocumentationPartCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDocumentationPartCommandInput): import("@smithy/core/client").CommandImpl<GetDocumentationPartCommandInput, GetDocumentationPartCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
