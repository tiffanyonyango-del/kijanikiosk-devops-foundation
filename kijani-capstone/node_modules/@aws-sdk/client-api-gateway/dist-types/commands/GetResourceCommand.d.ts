...
declare const GetResourceCommand_base: {
    new (input: GetResourceCommandInput): import("@smithy/core/client").CommandImpl<GetResourceCommandInput, GetResourceCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetResourceCommandInput): import("@smithy/core/client").CommandImpl<GetResourceCommandInput, GetResourceCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
