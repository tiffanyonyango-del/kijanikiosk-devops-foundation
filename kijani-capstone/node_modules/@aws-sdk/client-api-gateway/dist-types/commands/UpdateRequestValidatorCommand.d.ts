...
declare const UpdateRequestValidatorCommand_base: {
    new (input: UpdateRequestValidatorCommandInput): import("@smithy/core/client").CommandImpl<UpdateRequestValidatorCommandInput, UpdateRequestValidatorCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateRequestValidatorCommandInput): import("@smithy/core/client").CommandImpl<UpdateRequestValidatorCommandInput, UpdateRequestValidatorCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
