...
declare const UpdateClientCertificateCommand_base: {
    new (input: UpdateClientCertificateCommandInput): import("@smithy/core/client").CommandImpl<UpdateClientCertificateCommandInput, UpdateClientCertificateCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateClientCertificateCommandInput): import("@smithy/core/client").CommandImpl<UpdateClientCertificateCommandInput, UpdateClientCertificateCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
