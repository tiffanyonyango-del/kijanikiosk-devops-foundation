...
declare const DeleteDocumentationPartCommand_base: {
    new (input: DeleteDocumentationPartCommandInput): import("@smithy/core/client").CommandImpl<DeleteDocumentationPartCommandInput, DeleteDocumentationPartCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDocumentationPartCommandInput): import("@smithy/core/client").CommandImpl<DeleteDocumentationPartCommandInput, DeleteDocumentationPartCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
