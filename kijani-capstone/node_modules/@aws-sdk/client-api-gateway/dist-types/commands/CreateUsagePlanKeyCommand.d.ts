...
declare const CreateUsagePlanKeyCommand_base: {
    new (input: CreateUsagePlanKeyCommandInput): import("@smithy/core/client").CommandImpl<CreateUsagePlanKeyCommandInput, CreateUsagePlanKeyCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateUsagePlanKeyCommandInput): import("@smithy/core/client").CommandImpl<CreateUsagePlanKeyCommandInput, CreateUsagePlanKeyCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
