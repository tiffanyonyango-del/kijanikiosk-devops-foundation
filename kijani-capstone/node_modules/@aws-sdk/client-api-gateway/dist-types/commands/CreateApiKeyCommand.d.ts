...
declare const CreateApiKeyCommand_base: {
    new (input: CreateApiKeyCommandInput): import("@smithy/core/client").CommandImpl<CreateApiKeyCommandInput, CreateApiKeyCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateApiKeyCommandInput]): import("@smithy/core/client").CommandImpl<CreateApiKeyCommandInput, CreateApiKeyCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
