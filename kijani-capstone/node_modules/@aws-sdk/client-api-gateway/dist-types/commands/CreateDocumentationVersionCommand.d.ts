...
declare const CreateDocumentationVersionCommand_base: {
    new (input: CreateDocumentationVersionCommandInput): import("@smithy/core/client").CommandImpl<CreateDocumentationVersionCommandInput, CreateDocumentationVersionCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateDocumentationVersionCommandInput): import("@smithy/core/client").CommandImpl<CreateDocumentationVersionCommandInput, CreateDocumentationVersionCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
