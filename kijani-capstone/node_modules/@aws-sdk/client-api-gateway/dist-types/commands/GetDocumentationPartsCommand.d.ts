...
declare const GetDocumentationPartsCommand_base: {
    new (input: GetDocumentationPartsCommandInput): import("@smithy/core/client").CommandImpl<GetDocumentationPartsCommandInput, GetDocumentationPartsCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDocumentationPartsCommandInput): import("@smithy/core/client").CommandImpl<GetDocumentationPartsCommandInput, GetDocumentationPartsCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
