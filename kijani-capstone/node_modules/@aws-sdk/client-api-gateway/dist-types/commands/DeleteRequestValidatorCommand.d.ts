...
declare const DeleteRequestValidatorCommand_base: {
    new (input: DeleteRequestValidatorCommandInput): import("@smithy/core/client").CommandImpl<DeleteRequestValidatorCommandInput, DeleteRequestValidatorCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteRequestValidatorCommandInput): import("@smithy/core/client").CommandImpl<DeleteRequestValidatorCommandInput, DeleteRequestValidatorCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
