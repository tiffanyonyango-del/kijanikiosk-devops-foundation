...
declare const UpdateDocumentationVersionCommand_base: {
    new (input: UpdateDocumentationVersionCommandInput): import("@smithy/core/client").CommandImpl<UpdateDocumentationVersionCommandInput, UpdateDocumentationVersionCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateDocumentationVersionCommandInput): import("@smithy/core/client").CommandImpl<UpdateDocumentationVersionCommandInput, UpdateDocumentationVersionCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
