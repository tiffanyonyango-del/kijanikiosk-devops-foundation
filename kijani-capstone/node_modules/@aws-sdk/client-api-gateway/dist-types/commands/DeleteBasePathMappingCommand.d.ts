...
declare const DeleteBasePathMappingCommand_base: {
    new (input: DeleteBasePathMappingCommandInput): import("@smithy/core/client").CommandImpl<DeleteBasePathMappingCommandInput, DeleteBasePathMappingCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteBasePathMappingCommandInput): import("@smithy/core/client").CommandImpl<DeleteBasePathMappingCommandInput, DeleteBasePathMappingCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
