...
declare const DeleteMethodCommand_base: {
    new (input: DeleteMethodCommandInput): import("@smithy/core/client").CommandImpl<DeleteMethodCommandInput, DeleteMethodCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteMethodCommandInput): import("@smithy/core/client").CommandImpl<DeleteMethodCommandInput, DeleteMethodCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
