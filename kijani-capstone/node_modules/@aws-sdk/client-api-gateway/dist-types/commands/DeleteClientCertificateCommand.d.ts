...
declare const DeleteClientCertificateCommand_base: {
    new (input: DeleteClientCertificateCommandInput): import("@smithy/core/client").CommandImpl<DeleteClientCertificateCommandInput, DeleteClientCertificateCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteClientCertificateCommandInput): import("@smithy/core/client").CommandImpl<DeleteClientCertificateCommandInput, DeleteClientCertificateCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
