...
declare const DeleteDocumentationVersionCommand_base: {
    new (input: DeleteDocumentationVersionCommandInput): import("@smithy/core/client").CommandImpl<DeleteDocumentationVersionCommandInput, DeleteDocumentationVersionCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDocumentationVersionCommandInput): import("@smithy/core/client").CommandImpl<DeleteDocumentationVersionCommandInput, DeleteDocumentationVersionCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
