...
declare const UpdateUsageCommand_base: {
    new (input: UpdateUsageCommandInput): import("@smithy/core/client").CommandImpl<UpdateUsageCommandInput, UpdateUsageCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateUsageCommandInput): import("@smithy/core/client").CommandImpl<UpdateUsageCommandInput, UpdateUsageCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
