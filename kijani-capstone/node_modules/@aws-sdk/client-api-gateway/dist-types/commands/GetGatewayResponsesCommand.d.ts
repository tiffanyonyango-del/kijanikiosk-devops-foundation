...
declare const GetGatewayResponsesCommand_base: {
    new (input: GetGatewayResponsesCommandInput): import("@smithy/core/client").CommandImpl<GetGatewayResponsesCommandInput, GetGatewayResponsesCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetGatewayResponsesCommandInput): import("@smithy/core/client").CommandImpl<GetGatewayResponsesCommandInput, GetGatewayResponsesCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
