...
declare const GetGatewayResponseCommand_base: {
    new (input: GetGatewayResponseCommandInput): import("@smithy/core/client").CommandImpl<GetGatewayResponseCommandInput, GetGatewayResponseCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetGatewayResponseCommandInput): import("@smithy/core/client").CommandImpl<GetGatewayResponseCommandInput, GetGatewayResponseCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
