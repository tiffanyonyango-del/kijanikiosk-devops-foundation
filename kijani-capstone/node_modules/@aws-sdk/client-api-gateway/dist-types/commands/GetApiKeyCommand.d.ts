...
declare const GetApiKeyCommand_base: {
    new (input: GetApiKeyCommandInput): import("@smithy/core/client").CommandImpl<GetApiKeyCommandInput, GetApiKeyCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetApiKeyCommandInput): import("@smithy/core/client").CommandImpl<GetApiKeyCommandInput, GetApiKeyCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
