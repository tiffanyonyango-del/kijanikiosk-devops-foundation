...
declare const GetSdkCommand_base: {
    new (input: GetSdkCommandInput): import("@smithy/core/client").CommandImpl<GetSdkCommandInput, GetSdkCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetSdkCommandInput): import("@smithy/core/client").CommandImpl<GetSdkCommandInput, GetSdkCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
