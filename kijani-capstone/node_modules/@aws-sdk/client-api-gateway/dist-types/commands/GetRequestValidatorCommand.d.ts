...
declare const GetRequestValidatorCommand_base: {
    new (input: GetRequestValidatorCommandInput): import("@smithy/core/client").CommandImpl<GetRequestValidatorCommandInput, GetRequestValidatorCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetRequestValidatorCommandInput): import("@smithy/core/client").CommandImpl<GetRequestValidatorCommandInput, GetRequestValidatorCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
