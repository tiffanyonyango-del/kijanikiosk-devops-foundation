...
declare const GetUsagePlanCommand_base: {
    new (input: GetUsagePlanCommandInput): import("@smithy/core/client").CommandImpl<GetUsagePlanCommandInput, GetUsagePlanCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetUsagePlanCommandInput): import("@smithy/core/client").CommandImpl<GetUsagePlanCommandInput, GetUsagePlanCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
