...
declare const DeleteGatewayResponseCommand_base: {
    new (input: DeleteGatewayResponseCommandInput): import("@smithy/core/client").CommandImpl<DeleteGatewayResponseCommandInput, DeleteGatewayResponseCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteGatewayResponseCommandInput): import("@smithy/core/client").CommandImpl<DeleteGatewayResponseCommandInput, DeleteGatewayResponseCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
