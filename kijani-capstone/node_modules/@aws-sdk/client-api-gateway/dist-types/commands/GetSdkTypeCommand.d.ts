...
declare const GetSdkTypeCommand_base: {
    new (input: GetSdkTypeCommandInput): import("@smithy/core/client").CommandImpl<GetSdkTypeCommandInput, GetSdkTypeCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetSdkTypeCommandInput): import("@smithy/core/client").CommandImpl<GetSdkTypeCommandInput, GetSdkTypeCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
