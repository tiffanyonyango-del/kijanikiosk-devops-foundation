...
declare const GetResourcesCommand_base: {
    new (input: GetResourcesCommandInput): import("@smithy/core/client").CommandImpl<GetResourcesCommandInput, GetResourcesCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetResourcesCommandInput): import("@smithy/core/client").CommandImpl<GetResourcesCommandInput, GetResourcesCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
