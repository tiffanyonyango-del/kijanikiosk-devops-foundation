...
declare const UpdateBasePathMappingCommand_base: {
    new (input: UpdateBasePathMappingCommandInput): import("@smithy/core/client").CommandImpl<UpdateBasePathMappingCommandInput, UpdateBasePathMappingCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateBasePathMappingCommandInput): import("@smithy/core/client").CommandImpl<UpdateBasePathMappingCommandInput, UpdateBasePathMappingCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
