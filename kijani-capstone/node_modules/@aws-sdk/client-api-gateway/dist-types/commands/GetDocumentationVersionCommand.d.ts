...
declare const GetDocumentationVersionCommand_base: {
    new (input: GetDocumentationVersionCommandInput): import("@smithy/core/client").CommandImpl<GetDocumentationVersionCommandInput, GetDocumentationVersionCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDocumentationVersionCommandInput): import("@smithy/core/client").CommandImpl<GetDocumentationVersionCommandInput, GetDocumentationVersionCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
