...
declare const DeleteRestApiCommand_base: {
    new (input: DeleteRestApiCommandInput): import("@smithy/core/client").CommandImpl<DeleteRestApiCommandInput, DeleteRestApiCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteRestApiCommandInput): import("@smithy/core/client").CommandImpl<DeleteRestApiCommandInput, DeleteRestApiCommandOutput, import("..").APIGatewayClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
